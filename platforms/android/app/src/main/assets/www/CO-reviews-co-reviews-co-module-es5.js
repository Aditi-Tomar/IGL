...
var ReviewsCOPageRoutingModule = /** @class */ (function () {
    function ReviewsCOPageRoutingModule() {
    }
    ...
    return ReviewsCOPageRoutingModule;
}());
...
var ReviewsCOPageModule = /** @class */ (function () {
    function ReviewsCOPageModule() {
    }
...
var ReviewsCOPage = /** @class */ (function () {
    function ReviewsCOPage(formBuilder, router, modalController, activatedroute, commonServices, dp, actionSheetController, alertController, menu) {
    ...
    ReviewsCOPage.prototype.ngOnInit = function () {
    ...
    ReviewsCOPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuCO');
        this.menu.open('menuCO');
    };
    ReviewsCOPage.prototype.getSelectedDate = function (datePicker) {
    ...
    ReviewsCOPage.prototype.getReviewData = function () {
        var _this = this;
        // try {
        ...
        this.commonServices.postwithservice("GetStationsByCR", {
            ...
            if (data) {
                _this.arrReviewData = response;
                console.log(_this.arrReviewData);
                _this.newArrayafterremove = _this.arrReviewData.map(function (_a) {
                    var StationName = _a.StationName, SubmitStatus = _a.SubmitStatus, rest = tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"](_a, ["StationName", "SubmitStatus"]);
                    return rest;
                });
                console.log(_this.newArrayafterremove);
                // this.stationToSubmit = this.arrReviewData.filter(
                //   arrayobj => arrayobj.SubmitStatus == "1"); 
                if (_this.arrReviewData[0].isSentToHo == 1)
                    _this.outerCheck = 1;
                else
                    _this.outerCheck = 0;
                ...
                _this.commonServices.presentToast('Data not found.');
            }
    ...
    // For Final Approve
    ReviewsCOPage.prototype.makeFinalApprove = function () {
        console.log(this.glovalJson[0].LoginId);
        var temparray = [];
        temparray = this.arrReviewData.filter(function (arrayobj) { return arrayobj.selected == true; });
    ...
    ReviewsCOPage.prototype.openModal = function () {
    ...
    ReviewsCOPage.prototype.conApprove = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ReviewsCOPage.prototype.FinalFileApprove = function () {
        var _this = this;
        console.log(this.glovalJson[0].LoginId);
        var temparray = [];
        temparray = this.arrReviewData.filter(function (arrayobj) { return arrayobj.selected == true; });
        ...
        temparray.forEach(function (element) {
            stJson.push({
                ...
                // DPREntryDate: this.geteDate.selcteddate
                DPREntryDate: _this.dp.transform(_this.geteDate.selcteddate, 'dd/MMM/yyyy')
            });
        });
        this.commonServices.loadingPresent();
        this.commonServices.postwithservice("FinalSubmitCO", stJson).subscribe(function (resp) {
            var data = resp;
            console.log(data);
            if (data.Status == 'false') {
                _this.commonServices.presentToast('Please save all the entries before final Approval.');
                _this.commonServices.loadingDismiss();
                return false;
            }
            else {
                _this.commonServices.loadingDismiss();
                _this.commonServices.presentToast('Data is Approved.');
                _this.getReviewData();
            }
        }, function (error) {
            _this.commonServices.presentToast('Something went wrong.');
    ...
    ReviewsCOPage.prototype.showStationCode = function (stname) {
        var item = this.arrReviewData.filter(function (item) { return item.StationName === stname; });
        console.log("station code", item);
        this.stationCode = item[0].StationCode;
        this.stationname = item[0].StationName;
        this.isShown = !this.isShown;
    };
    ReviewsCOPage.prototype.exportToExcel = function () {
        this.commonServices.exportToExcel(this.newArrayafterremove, 'ReviewData');
    };
    ReviewsCOPage.ctorParameters = function () { return [
...
//# sourceMappingURL=CO-reviews-co-reviews-co-module-es5.js.map