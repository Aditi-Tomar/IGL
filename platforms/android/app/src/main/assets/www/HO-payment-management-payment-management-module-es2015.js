...
let PaymentManagementPageRoutingModule = class PaymentManagementPageRoutingModule {
};
...
let PaymentManagementPageModule = class PaymentManagementPageModule {
};
...
let PaymentManagementPage = class PaymentManagementPage {
    ...
    paymentDelete(PaymentModeId) {
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.post("DeletePaymentMode", { PaymentModeId: PaymentModeId }).subscribe((res) => {
    ...
    exportFile() {
        ...
        this.commonServices.post("getAllDetails_CSV", { Status: this.payStatus, PageFlag: 'PaymentManagement' }).subscribe((resp) => {
...
PaymentManagementPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-payment-management-payment-management-module-es2015.js.map