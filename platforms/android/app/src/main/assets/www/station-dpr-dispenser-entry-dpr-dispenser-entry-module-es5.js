...
var DprDispenserEntryPageRoutingModule = /** @class */ (function () {
    function DprDispenserEntryPageRoutingModule() {
    }
    ...
    return DprDispenserEntryPageRoutingModule;
}());
...
var DprDispenserEntryPageModule = /** @class */ (function () {
    function DprDispenserEntryPageModule() {
    }
    ...
    return DprDispenserEntryPageModule;
}());
...
var DprDispenserEntryPage = /** @class */ (function () {
    function DprDispenserEntryPage(formBuilder, router, activatedroute, commonServices, menu, dp) {
    ...
    DprDispenserEntryPage.prototype.abc = function () {
        var self = this;
    ...
    DprDispenserEntryPage.prototype.checkEntryPending = function (str) {
        var _this = this;
        console.log(str + "str");
        var self = this;
        ...
        self.commonServices.post("CommonGetData", {
            ...
            if (data.Table[0].Msg == 'Allow') {
                ...
                if (str == 'initial') {
                    ...
                    var dt = new Date(riDateStation[1]);
            ...
            if (_this.CompanyId == '1' || _this.CompanyId == '2' || _this.CompanyId == '4' ||
                _this.CompanyId == '5' || _this.CompanyId == '6' || _this.CompanyId == '8' ||
                _this.CompanyId == '9' || _this.CompanyId == '10' || _this.CompanyId == '11') {
                _this.selectedShiftId = '4';
                _this.selectedSubShiftId = '6';
                _this.shiftsubshift = true;
            }
            else {
                _this.shiftsubshift = false;
            }
            self.commonServices.loadingDismiss();
        }, function (error) {
            self.commonServices.presentToast('Something went wrong.');
    ...
    DprDispenserEntryPage.prototype.GetStationCompany = function () {
        var _this = this;
        var self = this;
        self.commonServices.post("CommonGetData", { Flag: 'CompanyByStation', Id: self.selectedStation, Status: 1 }).subscribe(function (resp) {
            console.log(resp);
            ...
            if (self.CompanyId == '2' || self.CompanyId == '4' || self.CompanyId == '1' ||
                ...
                self.CompanyId == '9' || _this.CompanyId == '10' || _this.CompanyId == '11') {
    ...
    DprDispenserEntryPage.prototype.CheckCompany = function () {
    ...
    DprDispenserEntryPage.prototype.GetReadingbyShift = function () {
        var _this = this;
        var self = this;
        ...
        // self.commonServices.loadingDismiss();
        // self.commonServices.loadingPresent();
        self.commonServices.post("GetReadingbyShift", obj).subscribe(function (resp) {
            self.commonServices.loadingDismiss();
            ...
            if (self.DispencerCount != 0) {
                ...
                if (_this.CompanyId != '1' && _this.CompanyId != '2' && _this.CompanyId != '4' &&
                    ...
                    _this.cmbSubShiftData = JSON.parse(resp).Table5;
                }
                if (_this.CompanyId == '1' || _this.CompanyId == '2' || _this.CompanyId == '4' ||
                    _this.CompanyId == '5' || _this.CompanyId == '6' || _this.CompanyId == '8' ||
                    _this.CompanyId == '9' || _this.CompanyId == '10' || _this.CompanyId == '11') {
                    ...
                    _this.selectedSubShiftId = '6';
                    _this.shiftsubshift = true;
                    console.log(_this.selectedSubShiftId, "Sub");
                }
                else {
    ...
    DprDispenserEntryPage.prototype.onSelectShift = function (shiftId) {
        var _this = this;
        this.selectedShiftId = shiftId;
        setTimeout(function () { _this.GetReadingbyShift(); });
        this.CheckDispenserLockUnlock();
    };
    DprDispenserEntryPage.prototype.onSelectSubShift = function (SubShiftId) {
        var _this = this;
        this.selectedSubShiftId = SubShiftId;
        var element = 0;
        for (var index = 0; index < this.cmbSubShiftData.length; index++) {
    ...
    DprDispenserEntryPage.prototype.numberOnly = function (event) {
        console.log(event);
    ...
    DprDispenserEntryPage.prototype.onChangeRishabh = function (itm) {
        var rx = /^[+-]?[0-9]{1,10}(?:\.[0-9]{1,3})?$/;
        console.log(rx.test(itm.ArmReadingA));
    };
    DprDispenserEntryPage.prototype.OnchangeA = function (itm) {
        ...
        var ArmASaleCal = ((parseFloat(itm.ArmReadingA) - parseFloat(itm.PreArmReadingA) -
            parseFloat(itm.JumpArmA)).toFixed(2)).toString();
        itm.TotA = Number(isNaN(parseFloat(ArmASaleCal)) ? '0.00' : ArmASaleCal);
        var TArmSaleCal = ((parseFloat(itm.TotA) + parseFloat(itm.TotB)).toFixed(2)).toString();
        itm.FinalTot = Number((isNaN(parseFloat(TArmSaleCal)) ? '0.00' : TArmSaleCal));
    };
    DprDispenserEntryPage.prototype.OnchangeB = function (itm) {
        ...
        var ArmBSaleCal = ((parseFloat(itm.ArmReadingB) - parseFloat(itm.PreArmReadingB) - parseFloat(itm.JumpArmB)).toFixed(2)).toString();
        itm.TotB = Number(isNaN(parseFloat(ArmBSaleCal)) ? '0.00' : ArmBSaleCal);
        var TArmSaleCal = ((parseFloat(itm.TotB) + parseFloat(itm.TotA)).toFixed(2)).toString();
        itm.FinalTot = Number((isNaN(parseFloat(TArmSaleCal)) ? '0.00' : TArmSaleCal));
    };
    DprDispenserEntryPage.prototype.saveAll = function () {
        var _this = this;
        console.log(this.allDispenserData);
        if (this.checkSale()) {
            var arr = [];
            arr = this.allDispenserData.filter(function (element) { return element.ArmReadingA != 0; });
            console.log(arr);
            if (this.selectedShiftId == "-1" || Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.selectedShiftId)) {
                ...
                console.log(this.allDispenserData);
                var array = [];
                this.allDispenserData.forEach(function (element) {
                ...
                this.commonServices.post("DispenserEntryMaster", (obj)).subscribe(function (resp) {
                    _this.CheckDispenserLockUnlock();
                    var data = JSON.parse(resp);
    ...
    // }
    DprDispenserEntryPage.prototype.CheckDispenserLockUnlock = function () {
        var _this = this;
        var obj = {
            // EntryDate: this.dp.transform(this.DispenserDate.selcteddate, 'dd/MMM/yyyy'),
        ...
        console.log(obj);
        this.commonServices.post("CheckDispencerLockUnlockStatus", (obj)).subscribe(function (resp) {
            var data = JSON.parse(resp);
            console.log(data);
            ...
            if (data.Table[0].Status == "1") {
                _this.isDispencerLocked = false;
                _this.DispLockMsg = data.Table[0].Message;
            }
            else {
                _this.isDispencerLocked = true;
                _this.DispLockMsg = "";
            }
        }, function (error) {
            _this.commonServices.presentToast("Something went wrong.");
    ...
    DprDispenserEntryPage.prototype.checkSale = function () {
        console.log(this.allDispenserData);
    ...
    DprDispenserEntryPage.prototype.validation1 = function (ArmReadingA, PreArmReadingA) {
        var _this = this;
        ...
        if (String(Number(ArmReadingA)) == 'NaN') {
            ...
            var ret = confirm('There is a suspecious entry in Arm A. Do you want to continue?');
            ...
            this.commonServices.postwithservice("DispenserAverage", {
                ...
                var data = JSON.parse(resp).Table[0];
                _this.ArmAReadingAverage = data.FinalArmA;
                _this.ArmBReadingAverage = data.FinalArmB;
                console.log(_this.ArmAReadingAverage, ",", _this.ArmBReadingAverage);
                if (ArmReadingA > _this.ArmAReadingAverage) {
                    ...
                    //   return true;
                    // }
                    var ret = _this.commonServices.alertMessage("Confirm", "Wrong Entry for Arm A Reading, Do you want to continue?").then(function (res) {
                        console.log(res);
                        if (!res) {
                            return true;
                        }
    ...
    DprDispenserEntryPage.prototype.validation2 = function (ArmReadingB, PreArmReadingB) {
        var _this = this;
        if (String(Number(ArmReadingB)) == 'NaN') {
            ...
            var ret = confirm('There is a suspecious entry in Arm B. Do you want to continue?');
            //this.errorFlag = (ret == true)?false:true; 
            return false; //This will not stop doing the entry, it's only for confirmation
        }
        else if (ArmReadingB == '') {
            ...
            this.commonServices.postwithservice("DispenserAverage", {
                ...
                _this.ArmBReadingAverage = data.FinalArmB;
                console.log(_this.ArmAReadingAverage, ",", _this.ArmBReadingAverage);
                if (ArmReadingB > _this.ArmBReadingAverage) {
                    _this.commonServices.alertMessage("Confirm", "Wrong Entry for Arm B Reading, Do you want to continue?").then(function (res) {
                        console.log(res);
                        if (!res) {
                            return false;
                        }
    ...
    DprDispenserEntryPage.prototype.getvalues = function (itm) {
        this.armSide = "ArmA";
        this.before = "";
        this.after = "";
        this.remark = "";
    ...
    DprDispenserEntryPage.prototype.getJumpReadingList = function (itm) {
        var _this = this;
        console.log(itm);
    ...
    DprDispenserEntryPage.ctorParameters = function () { return [
...
//# sourceMappingURL=station-dpr-dispenser-entry-dpr-dispenser-entry-module-es5.js.map