...
let PackagePage = class PackagePage {
    ...
    GetPackageDetail(PackageId) {
        ...
        this.commonServices.postwithservice("GetStationPackages", obj).subscribe((resp) => {
            const data = JSON.parse(resp);
            console.log(data);
            if (data.length > 0) {
                this.IsPackagehide = false;
                ...
                this.SelectedPkgId = { PkgId: this.PackageDetailJson[0].PackageId };
                this.PackageId = this.PackageDetailJson[0].PackageId;
                this.PKisCRSentToHo = Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.PackageDetailJson[0].isCRSentToHo) ?
                    0 : this.PackageDetailJson[0].isCRSentToHo;
                this.PKisStationSubmitted = Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.PackageDetailJson[0].isStationSubmitted) ?
                    0 : this.PackageDetailJson[0].isStationSubmitted;
                // this.getSFMJumpHistory('GET');
                // this.getDFMJumpHistory('GET');
                // this.getEFMJumpHistory('GET');
                if (!Object(util__WEBPACK_IMPORTED_MODULE_6__["isUndefined"])(this.PackageDetailJson)) {
                    if (data[0].length > 0)
                        this.SelectedPkgId = { PkgId: this.PackageDetailJson[0].PackageId };
                    ...
                    if (this.imgPathSFM != '' && !Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.imgPathSFM)) {
                        this.mdlImgShowSFM = true;
                    }
                    this.imgPathDFM = this.PackageDetailJson[0].JumpCertificateDFM;
                    if (this.imgPathDFM != '' && !Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.imgPathDFM)) {
                        this.mdlImgShowDFM = true;
                    }
                    this.imgPathEFM = this.PackageDetailJson[0].JumpCertificateEFM;
                    if (this.imgPathEFM != '' && !Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.imgPathEFM)) {
                        this.mdlImgShowEFM = true;
                    }
                    this.SuctionFlowMeterReading = Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.PackageDetailJson[0].SuctionFlowMeterReading) ? "0" : this.PackageDetailJson[0].SuctionFlowMeterReading;
                    this.SuctionFlowMeterReadingPrv = this.PackageDetailJson[0].SuctionFlowMeterReadingPrv;
                    console.log(this.SuctionFlowMeterReading, "SuctionFlowMeterReading");
                    console.log(this.SuctionFlowMeterReadingPrv, "SuctionFlowMeterReadingPrv");
                    console.log(this.PackageDetailJson[0].SuctionFlowMeterReading, "GAA");
                    ...
                    this.VentFlowMeterReading =
                        (this.PackageDetailJson[0].VentFlowMeterReading == ""
                            || Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.PackageDetailJson[0].VentFlowMeterReading)) ?
    ...
    InsertPackageInfo() {
        ...
        if (getAllFData.PromptErrorS != "") {
            this.errorS = true;
            this.commonServices.alertMessage("Confirm", getAllFData.PromptErrorS).then((res) => {
                console.log(res);
                if (res) {
                    // this.errorS = false;
                    return false;
        ...
        if (getAllFData.PromptErrorD != "") {
            this.errorD = true;
            this.commonServices.alertMessage("Confirm", getAllFData.PromptErrorD).then((res) => {
                console.log(res);
                if (res) {
                    // this.errorD = false;
                    return false;
        ...
        if (getAllFData.PromptErrorE != "") {
            this.errorE = true;
            this.commonServices.alertMessage("Confirm", getAllFData.PromptErrorE).then((res) => {
                console.log(res);
                if (res) {
                    // this.errorE = false;
                    return false;
        ...
        if (this.errorD == false && this.errorE == false && this.errorS == false) {
            ...
            this.commonServices.InsertPackageInfo(getAllFData.frmData).subscribe((resp) => {
                const data = resp;
                //this.commonServices.loadingDismiss();
                ...
                if (data.Status.indexOf('successfully') > -1) {
                    var MyJson = {
                        StationCode: this.StationCode,
                        LoginID: this.LoginId,
                        PackageId: ((Object(util__WEBPACK_IMPORTED_MODULE_6__["isUndefined"])(this.SelectedPkgId.PkgId) == true || this.SelectedPkgId.PkgId == '') ? '-999' : this.SelectedPkgId.PkgId)
                    };
    ...
    getPackageFD(pkgDetJson, GlobalDetail, SelectedPkgId, hrsJson, remarkJson) {
        ...
        this.commonServices.postwithservice("PackagesAverage", { LoginId: localStorage.getItem('LoginId'),
            DPREntryDate: this.dp.transform(this.geteDate.selcteddate, 'dd/MMM/yyyy') }).subscribe((resp) => {
    ...
    HoldResetReading(flag) {
        ...
        formData.append("jsonDetail", JSON.stringify(sendJosn));
        this.commonServices.loadingPresent();
        this.commonServices.PackageHoldResetReading(formData).subscribe((resp) => {
            this.commonServices.loadingDismiss();
            const data = resp;
            if (flag == 'SFM') {
                this.getSFMJumpHistory('GET');
    ...
    DeleteSFMJumpHistory(Id, FlagReading, itm) {
    ...
    DeleteDFMJumpHistory(Id, FlagReading, itm) {
        // if (confirm("Are you sure to delete this record..?")) {
        //   var Json = {
        //     Id: Id,
        //     FlagEntryFor: 'DELETE',
    ...
    DeleteEFMJumpHistory(Id, FlagReading, itm) {
        this.commonServices.alertMessage("Delete", "Are you sure to delete this record..?").then((res) => {
            console.log(res);
            if (!res) {
                var Json = {
    ...
    DeleteVFMJumpHistory(Id, FlagReading, itm) {
        this.commonServices.alertMessage("Delete", "Are you sure to delete this record..?").then((res) => {
            console.log(res);
            if (!res) {
                var Json = {
...
//# sourceMappingURL=station-package-package-module-es2015.js.map