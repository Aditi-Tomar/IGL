...
let BankDepositePageRoutingModule = class BankDepositePageRoutingModule {
};
...
let BankDepositePageModule = class BankDepositePageModule {
};
...
let BankDepositePage = class BankDepositePage {
    constructor(alertController, formBuilder, datepipe, router, activatedroute, commonServices, menu, dp) {
    ...
    GetDenominationsType() {
        this.commonServices.loadingDismiss();
        this.commonServices.loadingPresent();
        this.commonServices.post("GetDenominationsData", { StationId: this.detailsStation.StationId, DepositDate: this.detailsStation.SummeryDate }).subscribe((resp) => {
            this.commonServices.loadingDismiss();
        ...
        if (this.detailsStation.SummeryDate != '') {
            if (parseFloat(this.CashDeposit) <= (parseFloat(this.CurrentCash) +
                ...
                if (this.remark != '' && this.remark != undefined) {
                    // this.commonServices.loadingPresent();
                    this.commonServices.post("BankDepositPaymentCollection", { StationId: this.detailsStation.StationId, UserId: this.detailsStation.UserId, Remark: this.remark, DepositDate: this.detailsStation.SummeryDate, DispanserPayment: this.AddDenominationsType }).subscribe((resp) => {
                        const data = JSON.parse(resp);
                        this.commonServices.presentToast(data.Table[0].Meaasge);
                        // this.commonServices.loadingDismiss();
                        // $('.nav-tabs >').first('li').find('a').trigger('click');
...
BankDepositePage.ctorParameters = () => [
...
//# sourceMappingURL=station-bank-deposite-bank-deposite-module-es2015.js.map