...
let MOManagementPageRoutingModule = class MOManagementPageRoutingModule {
};
...
let MOManagementPageModule = class MOManagementPageModule {
};
...
let MOManagementPage = class MOManagementPage {
    ...
    getMoList() {
        ...
        self.commonServices.post("CommonGetData", { Flag: 'MOList', Id: '0', Status: self.DSStatus }).subscribe((res) => {
    ...
    exportFile() {
        this.commonServices.post("getAllDetails_CSV", { Flag: 'MOList', PageFlag: 'Mom', Status: this.DSStatus }).subscribe((resp) => {
...
MOManagementPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-mo-management-mo-management-module-es2015.js.map