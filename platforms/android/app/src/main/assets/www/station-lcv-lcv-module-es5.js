...
var LcvPage = /** @class */ (function () {
    function LcvPage(formBuilder, router, activatedroute, commonServices, menu, dp) {
    ...
    LcvPage.prototype.changResetRedirect = function () {
        this.router.navigate(['change-reset-lcv']);
    };
    LcvPage.prototype.showFields_jump = function () {
        if (this.flagJump == 0) {
            this.varJump = true;
            this.flagJump = 1;
        }
    ...
    LcvPage.prototype.getSelectedDate = function (datePicker) {
    ...
    LcvPage.prototype.showhidechangereset = function () {
        this.hidelcv = false;
    ...
    //   )
    // }
    LcvPage.prototype.GetStationLcv = function (id) {
        var _this = this;
        this.LCVuploadedfile = null;
        this.lcvid = id;
        this.LCVMeterTotaliserPrv = "";
        ...
        this.commonServices.postwithservice("GetStationLcv", {
            ...
            console.log(data);
            if (data[0].length != 0 && data[1].length != 0) {
                _this.IsLCVhide = false;
                _this.stationLcvData = JSON.parse(resp);
                _this.stationLcvData1 = JSON.parse(resp)[1];
                _this.stationLcvData2 = JSON.parse(resp)[0];
                _this.lcvmeterTotaliser = _this.stationLcvData1[0].LCVMeterTotaliser;
                _this.LCVjumpreading = _this.stationLcvData1[0].JumpReadingLCV;
                _this.jumpreadingcount = _this.stationLcvData1[0].JumpReadingLCVCount;
                _this.JumpCertificateLCV = _this.stationLcvData1[0].JumpCeritificateLCV;
                if (_this.JumpCertificateLCV != '')
                    _this.LCVShowJumpImage = true;
                else
                    _this.LCVShowJumpImage = false;
                _this.LCVremark = _this.stationLcvData1[0].Remark;
                _this.LCVisCRSentToHo = Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(_this.stationLcvData1[0].isCRSentToHo) ? 0 : _this.stationLcvData1[0].isCRSentToHo;
                _this.LCVisStationSubmitted = Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(_this.stationLcvData1[0].isStationSubmitted) ? 0 : _this.stationLcvData1[0].isStationSubmitted;
                console.log(_this.LCVisCRSentToHo, "LCVisCRSentToHo");
                console.log(_this.LCVisStationSubmitted, "LCVisStationSubmitted");
                if (parseFloat(_this.LCVjumpreading) > 0.000) {
                    _this.LCVfilevisible = false;
                    $("#Ischeckbox").prop("checked", true);
                    _this.LCVJumpVisible = false;
                }
                else {
                    _this.LCVfilevisible = true;
                    $("#Ischeckbox").prop("checked", false);
                    _this.LCVJumpVisible = true;
                }
                console.log(_this.stationLcvData);
                if (id == '-999') {
                    _this.lcvid = _this.stationLcvData2[0].LcvId;
                    _this.getLCVJumpHistory('GET');
                }
                _this.stationLcvData1.forEach(function (element) {
                    _this.LCVMeterTotaliserPrv = element.LCVMeterTotaliserPrv;
                    _this.SAPEquipmentNumber = element.LcvCode;
                });
                _this.commonServices.loadingDismiss();
            }
            else {
                _this.commonServices.presentToast('No LCV data available. Please try another station.');
                _this.commonServices.loadingDismiss();
                _this.IsLCVhide = true;
                _this.LCVisCRSentToHo = 0;
                _this.LCVisStationSubmitted = 0;
                console.log(_this.LCVisCRSentToHo, "LCVisCRSentToHo");
                console.log(_this.LCVisStationSubmitted, "LCVisStationSubmitted");
            }
        }, function (error) {
    ...
    LcvPage.prototype.fileupload = function (str) {
        this.LCVuploadedfile = str.target.files[0];
    };
    LcvPage.prototype.LCVfileuploadreset = function (str) {
        this.LCVuploadedfilereset = str.target.files[0];
    };
    LcvPage.prototype.fileuploadreset = function (str) {
        this.uploadedfilereset = str.target.files[0];
        ;
    };
    LcvPage.prototype.LCVjumpreadingValue = function (value) {
    ...
    LcvPage.prototype.InsertStationLCV = function () {
        var _this = this;
        var MyJson = {
        ...
        this.commonServices.postwithservice("LCVAverage", {
            ...
            _this.LcvReadingAverage = data.FinalAmount;
            console.log(_this.LcvReadingAverage);
            console.log(_this.lcvmeterTotaliser);
        }, function (error) {
            console.log(error);
            _this.commonServices.presentToast("Something went wrong.");
            _this.commonServices.loadingDismiss();
        ...
        if (ErrorMsg == '' || ErrorMsg == undefined) {
            if (Number(this.lcvmeterTotaliser) <= Number(this.LCVMeterTotaliserPrv)) {
                this.commonServices.alertMessage("Confirm", "Suspected Meter Totaliser Reading, Do you want to continue?").then(function (res) {
                    console.log(res);
                    if (!res) {
                        // if (confirm("Suspected Meter Totaliser Reading, Do you want to continue?")) {
                        _this.commonServices.loadingPresent();
                        _this.commonServices.InsertStationLCV(frmData).subscribe(function (resp) {
                            var data = resp;
                            console.log(data);
                            _this.commonServices.presentToast(data);
                            if (data != '') {
                                _this.GetStationLcv(_this.lcvid);
                            }
                            _this.commonServices.loadingDismiss();
                        }, function (error) {
                            _this.commonServices.presentToast('Something went wrong.');
                ...
                this.commonServices.alertMessage("Confirm", "Wrong Entry for Meter Totaliser Reading, Do you want to continue?").then(function (res) {
                    console.log(res);
                    if (!res) {
                        _this.commonServices.InsertStationLCV(frmData).subscribe(function (resp) {
                            var data = resp;
                ...
                this.commonServices.loadingPresent();
                this.commonServices.InsertStationLCV(frmData).subscribe(function (resp) {
                    var data = resp;
                    console.log(data);
                    _this.commonServices.presentToast(data);
                    if (data != '') {
    ...
    LcvPage.prototype.checkStationValidations = function (LcvDetailJson) {
    ...
    LcvPage.prototype.LCVresetchange = function (value) {
        this.resetTypeJsonSelected = value;
    };
    LcvPage.prototype.JReadingvalue = function (value) {
        this.JReading = value;
    };
    LcvPage.prototype.getLCVJumpHistory = function (FlagType) {
        var _this = this;
        this.clearLCV();
        var obj = {
        ...
        this.commonServices.postwithservice("GetJumpReadingList", obj).subscribe(function (resp) {
            _this.LCVJumpListHistory = JSON.parse(resp).Table;
            console.log(_this.LCVJumpListHistory);
            _this.commonServices.loadingDismiss();
        }, function (error) {
            _this.commonServices.presentToast("Something went wrong.");
            _this.commonServices.loadingDismiss();
    ...
    LcvPage.prototype.DeleteLCVJumpHistory = function (Id, FlagReading, itm) {
        var _this = this;
    ...
    LcvPage.prototype.UpdateLCVJumpHistory = function (Id, itm) {
    ...
    LcvPage.prototype.LCVJReadingvalue = function (value) {
        this.JReading = value;
    };
    LcvPage.prototype.clearLCV = function () {
        this.LCVFlagJumpType = "J";
    ...
    //   this.getLCVJumpHistory('GET');
    // }
    LcvPage.prototype.LCVchangeresetpopup = function () {
        var _this = this;
        var MyJsonreset = {
            StationCode: localStorage.getItem('LoginId'),
            MeterOf: 'LCV',
    ...
    LcvPage.prototype.LCVchangeresetValidation = function (LcvDetailJsonreset, fileInput) {
        var regexNumeric = /^[+-]?[0-9]{1,1000}(?:\.[0-9]{1,1000})?$/;
        var regexDecimalThree = /^[+-]?[0-9]{1,10}(?:\.[0-9]{1,3})?$/;
        var regexDecimalThreeNegative = /^[+]?[0-9]{1,10}(?:\.[0-9]{1,3})?$/;
        var imgShow = 'assets/images/attachment.gif';
    ...
    LcvPage.prototype.changeresetValidations = function (LcvDetailJsonreset, fileInput) {
        var regexNumeric = /^[+-]?[0-9]{1,1000}(?:\.[0-9]{1,1000})?$/;
        var regexDecimalThree = /^[+-]?[0-9]{1,10}(?:\.[0-9]{1,3})?$/;
        var regexDecimalThreeNegative = /^[+]?[0-9]{1,10}(?:\.[0-9]{1,3})?$/;
        var imgShow = 'assets/images/attachment.gif';
...
//# sourceMappingURL=station-lcv-lcv-module-es5.js.map