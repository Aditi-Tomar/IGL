...
let RejectStationDprPageRoutingModule = class RejectStationDprPageRoutingModule {
};
...
let RejectStationDprPageModule = class RejectStationDprPageModule {
};
...
let RejectStationDprPage = class RejectStationDprPage {
    constructor(formBuilder, router, datepipe, activatedroute, commonServices, menu) {
    ...
    getRejectDetails() {
        ...
        self.commonServices.postwithservice("GetStationsByAdmin", { ControlRoomCode: self.SelectedCRm,
            Flag: 'FillStation', Rejectiondate: this.datepipe.transform(this.rejectiondatE, 'dd/MMM/yyyy') }).subscribe((res) => {
...
RejectStationDprPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-reject-station-dpr-reject-station-dpr-module-es2015.js.map