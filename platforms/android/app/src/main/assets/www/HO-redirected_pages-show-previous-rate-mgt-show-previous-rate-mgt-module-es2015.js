...
let ShowPreviousRateMgtPageRoutingModule = class ShowPreviousRateMgtPageRoutingModule {
};
...
let ShowPreviousRateMgtPageModule = class ShowPreviousRateMgtPageModule {
};
...
let ShowPreviousRateMgtPage = class ShowPreviousRateMgtPage {
    constructor(router, commonServices) {
        this.router = router;
    ...
    getRateList() {
        ...
        self.commonServices.post("CommonGetData", { Flag: 'RateList', Id: '0' }).subscribe((res) => {
...
ShowPreviousRateMgtPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-redirected_pages-show-previous-rate-mgt-show-previous-rate-mgt-module-es2015.js.map