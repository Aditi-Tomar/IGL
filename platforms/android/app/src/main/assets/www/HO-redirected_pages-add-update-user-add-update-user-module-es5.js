...
var AddUpdateUserPageRoutingModule = /** @class */ (function () {
    function AddUpdateUserPageRoutingModule() {
    }
    ...
    return AddUpdateUserPageRoutingModule;
}());
...
var AddUpdateUserPageModule = /** @class */ (function () {
    function AddUpdateUserPageModule() {
    }
    ...
    return AddUpdateUserPageModule;
}());
...
var AddUpdateUserPage = /** @class */ (function () {
    function AddUpdateUserPage(formBuilder, router, activatedroute, commonServices) {
    ...
    AddUpdateUserPage.prototype.ngAfterContentInit = function () {
        this.updateItemList();
    };
    AddUpdateUserPage.prototype.ngOnInit = function () {
        if (this.pageFlag == "updatepage") {
            this.Itemlist = JSON.parse(this.activatedroute.snapshot.paramMap.get('itemList'));
        }
        this.getPermision();
    };
    AddUpdateUserPage.prototype.updateItemList = function () {
        var self = this;
    ...
    AddUpdateUserPage.prototype.getPermision = function () {
        var _this = this;
        var self = this;
        self.commonServices.post("CommonGetData", { Flag: 'PermisionType', Id: 0, Status: "" }).subscribe(function (res) {
            ...
            if (_this.Itemlist != null && _this.Itemlist != '') {
                var arr = self.StationList.filter(function (item) {
    ...
    AddUpdateUserPage.prototype.onPermisionSelect = function (val) {
    ...
    AddUpdateUserPage.prototype.insertUpdateData = function () {
        var self = this;
        var statusToggle = 2;
        ...
        if (self.pageFlag == "updatepage") {
            ...
            if (self.ValidationUsers()) {
                ...
                self.commonServices.post("insertUpdateUserMaster", self.obj).subscribe(function (res) {
    ...
    AddUpdateUserPage.prototype.ValidationUsers = function () {
    ...
    AddUpdateUserPage.prototype.filterBoxShow = function (itm) {
    ...
    AddUpdateUserPage.prototype.onSearchTerm = function (ev) {
    ...
    AddUpdateUserPage.ctorParameters = function () { return [
...
//# sourceMappingURL=HO-redirected_pages-add-update-user-add-update-user-module-es5.js.map