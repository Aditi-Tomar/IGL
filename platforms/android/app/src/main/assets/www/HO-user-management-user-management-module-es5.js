...
var UserManagementPageRoutingModule = /** @class */ (function () {
    function UserManagementPageRoutingModule() {
    }
    ...
    return UserManagementPageRoutingModule;
}());
...
var UserManagementPage = /** @class */ (function () {
    function UserManagementPage(router, commonServices, menu) {
        this.router = router;
    ...
    UserManagementPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuCO');
        this.menu.open('menuCO');
    };
    UserManagementPage.prototype.segmentChanged = function (value) {
        console.log(value);
    ...
    UserManagementPage.prototype.getList = function () {
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.post("CommonGetData", { Flag: 'AlluserDetsils', Id: 0, Status: self.DSStatus }).subscribe(function (res) {
    ...
    UserManagementPage.prototype.goToadd = function () {
        this.router.navigate(['add-update-user', { itemList: '', pageFlag: "addpage" }]);
    };
    UserManagementPage.prototype.goToUpdate = function (item) {
        console.log(item);
    ...
    UserManagementPage.prototype.searchCollapse = function () {
    ...
    UserManagementPage.prototype.hideSearchBar = function () {
        this.searchShow = false;
        this.searchFlag = 0;
    };
    UserManagementPage.prototype.getItems = function (ev) {
        ...
        if (val && val.trim() != '') {
            ...
            this.items = this.getListRes.filter(function (item) {
                return (item.LoginId.toLowerCase().indexOf(val.toLowerCase()) > -1);
            });
            console.log(this.items);
        }
    };
    UserManagementPage.prototype.exportFile = function () {
        var _this = this;
        this.commonServices.post("getAllDetails_CSV", { Flag: "AlluserDetsils", Id: '0', Status: this.DSStatus, PageFlag: 'UsersManagement' }).subscribe(function (resp) {
    ...
    UserManagementPage.ctorParameters = function () { return [
...
//# sourceMappingURL=HO-user-management-user-management-module-es5.js.map