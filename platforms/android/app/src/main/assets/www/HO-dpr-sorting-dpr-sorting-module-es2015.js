...
let DprSortingPageRoutingModule = class DprSortingPageRoutingModule {
};
...
let DprSortingPageModule = class DprSortingPageModule {
};
...
let DprSortingPage = class DprSortingPage {
    constructor(menu) {
        this.menu = menu;
    }
    ngOnInit() {
...
//# sourceMappingURL=HO-dpr-sorting-dpr-sorting-module-es2015.js.map