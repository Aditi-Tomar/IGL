...
var SummaryDsaPageRoutingModule = /** @class */ (function () {
    function SummaryDsaPageRoutingModule() {
    }
    ...
    return SummaryDsaPageRoutingModule;
}());
...
var SummaryDsaPageModule = /** @class */ (function () {
    function SummaryDsaPageModule() {
    }
...
var SummaryDsaPage = /** @class */ (function () {
    function SummaryDsaPage(menu) {
        this.menu = menu;
    }
    SummaryDsaPage.prototype.ngOnInit = function () {
    };
    SummaryDsaPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuDsaSmry');
        this.menu.open('menuDsaSmry');
    };
    SummaryDsaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=HO-summary-dsa-summary-dsa-module-es5.js.map