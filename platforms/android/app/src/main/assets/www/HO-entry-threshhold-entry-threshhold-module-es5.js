...
var EntryThreshholdPageRoutingModule = /** @class */ (function () {
    function EntryThreshholdPageRoutingModule() {
    }
    ...
    return EntryThreshholdPageRoutingModule;
}());
...
var EntryThreshholdPageModule = /** @class */ (function () {
    function EntryThreshholdPageModule() {
    }
    ...
    return EntryThreshholdPageModule;
}());
...
var EntryThreshholdPage = /** @class */ (function () {
    function EntryThreshholdPage(router, commonServices, menu, alertController) {
        this.router = router;
    ...
    EntryThreshholdPage.prototype.ngOnInit = function () {
        // this.getEntryThresholdList();
    };
    EntryThreshholdPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuCO');
        this.menu.open('menuCO');
    };
    EntryThreshholdPage.prototype.segmentChanged = function (value) {
        console.log(value);
    ...
    EntryThreshholdPage.prototype.ionViewWillEnter = function () {
        this.getEntryThresholdList();
    };
    EntryThreshholdPage.prototype.getEntryThresholdList = function () {
        var self = this;
    ...
    EntryThreshholdPage.prototype.getItems = function (ev) {
        ...
        if (val && val.trim() != '') {
            ...
            this.items = this.listEntryThreshold.filter(function (item) {
                return (item.MeterType.toLowerCase().indexOf(val.toLowerCase()) > -1);
            });
            console.log(this.items);
        }
    };
    EntryThreshholdPage.prototype.goToAddEntryThreshold = function () {
        this.router.navigate(['add-update-entry-threshhold', { pageFlag: "addds" }]);
    };
    EntryThreshholdPage.prototype.goToUpdateEntryThreshold = function (item) {
        this.router.navigate(['add-update-entry-threshhold', { threshholdbj: JSON.stringify(item), pageFlag: "updateds" }]);
    };
    EntryThreshholdPage.prototype.searchCollapse = function () {
    ...
    EntryThreshholdPage.prototype.hideSearchBar = function () {
        this.searchShow = false;
        this.searchFlag = 0;
    };
    EntryThreshholdPage.ctorParameters = function () { return [
...
//# sourceMappingURL=HO-entry-threshhold-entry-threshhold-module-es5.js.map