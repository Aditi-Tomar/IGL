...
var MoDashboardPageRoutingModule = /** @class */ (function () {
    function MoDashboardPageRoutingModule() {
    }
    ...
    return MoDashboardPageRoutingModule;
}());
...
var MoDashboardPageModule = /** @class */ (function () {
    function MoDashboardPageModule() {
    }
...
var MoDashboardPage = /** @class */ (function () {
    function MoDashboardPage(router, menu) {
        this.router = router;
        this.menu = menu;
    }
    MoDashboardPage.prototype.ngOnInit = function () {
    };
    MoDashboardPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuCO');
        this.menu.open('menuCO');
    };
    MoDashboardPage.prototype.dashboardDSARedirect = function () {
        // this.router.navigateByUrl('dashboard-dsa');
        this.router.navigateByUrl('dashboard-mo');
    };
    ;
    MoDashboardPage.prototype.reportDSARedirect = function () {
        this.router.navigate(['dsa-report-mgt']);
        //this.router.navigateByUrl('report-dsa');
    };
    MoDashboardPage.prototype.stnDetailRedirect = function () {
        this.router.navigateByUrl('mostation-detail');
    };
    MoDashboardPage.prototype.dsmMgtRedirect = function () {
        this.router.navigateByUrl('modsm-management');
    };
    ;
    MoDashboardPage.prototype.attachDsaRedirect = function () {
        this.router.navigateByUrl('attachment-dsa');
    };
    MoDashboardPage.prototype.jumpReadingRedirect = function () {
        this.router.navigate(['jump-reading-system']);
    };
    MoDashboardPage.ctorParameters = function () { return [
...
//# sourceMappingURL=MO-mo-dashboard-mo-dashboard-module-es5.js.map