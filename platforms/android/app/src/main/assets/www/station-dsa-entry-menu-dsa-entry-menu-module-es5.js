...
var DsaEntryMenuPageRoutingModule = /** @class */ (function () {
    function DsaEntryMenuPageRoutingModule() {
    }
    ...
    return DsaEntryMenuPageRoutingModule;
}());
...
var DsaEntryMenuPageModule = /** @class */ (function () {
    function DsaEntryMenuPageModule() {
    }
...
var DsaEntryMenuPage = /** @class */ (function () {
    function DsaEntryMenuPage(router, menu) {
        this.router = router;
        this.menu = menu;
    }
    DsaEntryMenuPage.prototype.ngOnInit = function () {
    };
    DsaEntryMenuPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuStn');
        this.menu.open('menuStn');
    };
    DsaEntryMenuPage.prototype.dsaEntryRedirect = function () {
        this.router.navigateByUrl('dsa-entry');
    };
    DsaEntryMenuPage.ctorParameters = function () { return [
...
//# sourceMappingURL=station-dsa-entry-menu-dsa-entry-menu-module-es5.js.map