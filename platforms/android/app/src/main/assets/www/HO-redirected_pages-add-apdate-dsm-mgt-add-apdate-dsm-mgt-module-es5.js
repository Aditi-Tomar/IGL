...
var AddApdateDsmMgtPageRoutingModule = /** @class */ (function () {
    function AddApdateDsmMgtPageRoutingModule() {
    }
    ...
    return AddApdateDsmMgtPageRoutingModule;
}());
...
var AddApdateDsmMgtPageModule = /** @class */ (function () {
    function AddApdateDsmMgtPageModule() {
    }
    ...
    return AddApdateDsmMgtPageModule;
}());
...
var AddApdateDsmMgtPage = /** @class */ (function () {
    function AddApdateDsmMgtPage(formBuilder, router, activatedroute, commonServices) {
    ...
    AddApdateDsmMgtPage.prototype.ngAfterContentInit = function () {
        this.updateDm();
    };
    AddApdateDsmMgtPage.prototype.ngOnInit = function () {
        this.dmlist = JSON.parse(this.activatedroute.snapshot.paramMap.get('dmlist'));
        this.getStation();
    };
    AddApdateDsmMgtPage.prototype.getStation = function () {
        var self = this;
    ...
    AddApdateDsmMgtPage.prototype.updateDm = function () {
        var self = this;
    ...
    AddApdateDsmMgtPage.prototype.insertUpdateDm = function () {
        var self = this;
        var statusToggle = 2;
    ...
    AddApdateDsmMgtPage.prototype.ValidationDSM = function () {
    ...
    AddApdateDsmMgtPage.ctorParameters = function () { return [
...
//# sourceMappingURL=HO-redirected_pages-add-apdate-dsm-mgt-add-apdate-dsm-mgt-module-es5.js.map