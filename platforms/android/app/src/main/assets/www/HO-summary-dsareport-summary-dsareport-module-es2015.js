...
let SummaryDSAReportPageRoutingModule = class SummaryDSAReportPageRoutingModule {
};
...
let SummaryDSAReportPageModule = class SummaryDSAReportPageModule {
};
...
let SummaryDSAReportPage = class SummaryDSAReportPage {
    constructor(formBuilder, menu, router, datepipe, activatedroute, commonServices) {
    ...
    getStationList() {
        ...
        self.commonServices.post("CommonGetData", { Id: 0, CompanyId: 0, ReportFlag: 'HO', Flag: 'GetAllStationsForDSA', Status: '', UserId: 1 }).subscribe((res) => {
    ...
    stationViewData() {
        ...
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.post("getSummaryHOForAdmin", obj).subscribe((res) => {
    ...
    ExportToPdf() {
        ...
        this.commonServices.post('DispenserSummaryPDF_ForAdmin', obj).subscribe((resp) => {
            console.log(resp);
...
SummaryDSAReportPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-summary-dsareport-summary-dsareport-module-es2015.js.map