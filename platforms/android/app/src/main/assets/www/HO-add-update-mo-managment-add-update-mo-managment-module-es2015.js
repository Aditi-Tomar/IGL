...
let AddUpdateMoManagmentPageRoutingModule = class AddUpdateMoManagmentPageRoutingModule {
};
...
let AddUpdateMoManagmentPageModule = class AddUpdateMoManagmentPageModule {
};
...
let AddUpdateMoManagmentPage = class AddUpdateMoManagmentPage {
    ...
    InsertMo() {
        ...
        if (self.validationMom()) {
            ...
            self.commonServices.post("MOInsertUpdate", obj).subscribe((res) => {
...
AddUpdateMoManagmentPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-add-update-mo-managment-add-update-mo-managment-module-es2015.js.map