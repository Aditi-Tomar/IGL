...
let AddUpdatePaymentMgtPageRoutingModule = class AddUpdatePaymentMgtPageRoutingModule {
};
...
let AddUpdatePaymentMgtPageModule = class AddUpdatePaymentMgtPageModule {
};
...
let AddUpdatePaymentMgtPage = class AddUpdatePaymentMgtPage {
    ...
    Insertpayement() {
        ...
        if (self.validationDisp()) {
            ...
            self.commonServices.post("InsertUpdatePaymentMode", obj).subscribe((res) => {
...
AddUpdatePaymentMgtPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-redirected_pages-add-update-payment-mgt-add-update-payment-mgt-module-es2015.js.map