...
var AddDetailRegionmgtPageRoutingModule = /** @class */ (function () {
    function AddDetailRegionmgtPageRoutingModule() {
    }
    ...
    return AddDetailRegionmgtPageRoutingModule;
}());
...
var AddDetailRegionmgtPageModule = /** @class */ (function () {
    function AddDetailRegionmgtPageModule() {
    }
    ...
    return AddDetailRegionmgtPageModule;
}());
...
var AddDetailRegionmgtPage = /** @class */ (function () {
    function AddDetailRegionmgtPage(formBuilder, router, activatedroute, commonServices) {
    ...
    AddDetailRegionmgtPage.prototype.ngAfterContentInit = function () {
    ...
    AddDetailRegionmgtPage.prototype.ngOnInit = function () {
    ...
    AddDetailRegionmgtPage.prototype.InsertupdateRegion = function () {
        var self = this;
        var statusToggle = 2;
        ...
        if (self.ValidationRegion()) {
            ...
            self.commonServices.post("RegionInsertUpdate", obj).subscribe(function (res) {
    ...
    AddDetailRegionmgtPage.prototype.ValidationRegion = function () {
    ...
    AddDetailRegionmgtPage.ctorParameters = function () { return [
...
//# sourceMappingURL=HO-add-detail-regionmgt-add-detail-regionmgt-module-es5.js.map