...
let GenralEntryPageRoutingModule = class GenralEntryPageRoutingModule {
};
...
let GenralEntryPageModule = class GenralEntryPageModule {
};
...
let GenralEntryPage = class GenralEntryPage {
    ...
    InsertGeneralEntry() {
        ...
        this.commonServices.loadingPresent();
        this.commonServices.postwithservice("InsertGeneralEntry", getJson.retJson).subscribe((resp) => {
            console.log(resp);
            this.commonServices.loadingDismiss();
...
GenralEntryPage.ctorParameters = () => [
...
//# sourceMappingURL=station-genral-entry-genral-entry-module-es2015.js.map