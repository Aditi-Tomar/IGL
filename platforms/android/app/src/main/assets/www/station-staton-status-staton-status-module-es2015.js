...
let StatonStatusPageRoutingModule = class StatonStatusPageRoutingModule {
};
...
let StatonStatusPageModule = class StatonStatusPageModule {
};
...
let StatonStatusPage = class StatonStatusPage {
    constructor(router, activatedroute, commonServices, menu, dp) {
        this.router = router;
    ...
    getData() {
        ...
        self.commonServices.post("CommonGetData", { Flag: 'StationStatus', Id: self.Id,
            Status: self.StationId }).subscribe((res) => {
    ...
    getShift() {
        var self = this;
        self.commonServices.post("CommonGetData", { Flag: 'StationShift', Id: 0, Status: 1 }).subscribe((res) => {
    ...
    getSubShift() {
        var self = this;
        self.commonServices.post("CommonGetData", { Flag: 'SubShift', Id: self.SelectedShiftId, Status: 1 }).subscribe((res) => {
    ...
    getSubShift_To() {
        var self = this;
        self.commonServices.post("CommonGetData", { Flag: 'SubShift', Id: this.SelectedShiftId_To, Status: 1 }).subscribe((resp) => {
    ...
    insertRecord() {
        ...
        if (self.Validation()) {
            ...
            self.commonServices.post("InsertStationStatus", obj).subscribe((res) => {
...
StatonStatusPage.ctorParameters = () => [
...
//# sourceMappingURL=station-staton-status-staton-status-module-es2015.js.map