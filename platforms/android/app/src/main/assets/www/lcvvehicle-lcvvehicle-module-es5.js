...
var LCVvehiclePageRoutingModule = /** @class */ (function () {
    function LCVvehiclePageRoutingModule() {
    }
    ...
    return LCVvehiclePageRoutingModule;
}());
...
var LCVvehiclePageModule = /** @class */ (function () {
    function LCVvehiclePageModule() {
    }
...
var LCVvehiclePage = /** @class */ (function () {
    function LCVvehiclePage(router, menu, datepipe, commonServices, alertCtrl) {
        this.router = router;
        this.menu = menu;
    ...
    LCVvehiclePage.prototype.ngOnInit = function () {
        var dt = new Date();
    ...
    LCVvehiclePage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuStn');
        this.menu.open('menuStn');
    };
    LCVvehiclePage.prototype.getstationlist = function () {
        var _this = this;
        this.commonServices.post('CommonGetData', { Flag: 'Stationforlcvvehicle' }).subscribe(function (resp) {
            _this.listStation = JSON.parse(resp).Table;
            _this.filteredListStation = _this.listStation;
            console.log(_this.listStation, "listStation");
        }, function (error) {
            alert("Something went wrong.");
        });
    };
    LCVvehiclePage.prototype.getlcvlist = function () {
        var _this = this;
        this.commonServices.postwithservice("getlcvlist", { flag: 'get', Fromstation: this.stationCode, Entrydate: this.DateFrom }).subscribe(function (resp) {
            _this.lcvlist = JSON.parse(resp).Table;
            console.log(_this.lcvlist, "lcvlist");
            var retData = JSON.parse(resp).Table[0];
        }, function (error) {
            alert("Something went wrong.");
        });
    };
    LCVvehiclePage.prototype.filterBoxShow = function (itm) {
    ...
    LCVvehiclePage.prototype.OnDateChnageFrom = function (val) {
        var self = this;
        var dt = new Date(val);
    ...
    LCVvehiclePage.prototype.filterStations = function () {
        var _this = this;
        ...
        if (!this.filterItem || this.filterItem.trim() === '') {
            ...
            this.filteredListStation = this.listStation.filter(function (itm) {
                return itm.StationName.toLowerCase().includes(_this.filterItem.toLowerCase());
            });
        }
    };
    LCVvehiclePage.prototype.Deletelcv = function (Id) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        _this.commonServices.postwithservice("Deletelcv", Json).subscribe(function (resp) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                            var data, successAlert;
                                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                    ...
                                                    case 1:
                                                        successAlert = _a.sent();
                                                        return [4 /*yield*/, successAlert.present()];
                                                    case 2:
                                                        _a.sent();
                                                        this.getlcvlist();
                                                        return [2 /*return*/];
    ...
    LCVvehiclePage.prototype.InsertLCVVehicl = function () {
        var _this = this;
        // alert(this.stCodeMy);
        ...
        if (this.Validationlcv()) {
            ...
            this.commonServices.postwithservice("InsertLCVdata", obj).subscribe(function (resp) {
                _this.commonServices.presentToast(JSON.parse(resp)[0].msg);
                _this.SelectedStationCode = '';
                _this.stCodeMy = '';
                _this.LCVKG = '';
                _this.flag = '';
                _this.Trips = '';
    ...
    LCVvehiclePage.prototype.Validationlcv = function () {
    ...
    LCVvehiclePage.prototype.Edit = function (itm) {
        console.log(itm);
        this.stCodeMy = '';
    ...
    LCVvehiclePage.ctorParameters = function () { return [
...
//# sourceMappingURL=lcvvehicle-lcvvehicle-module-es5.js.map