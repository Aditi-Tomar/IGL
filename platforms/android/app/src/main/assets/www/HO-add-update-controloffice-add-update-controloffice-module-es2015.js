...
let AddUpdateControlofficePageRoutingModule = class AddUpdateControlofficePageRoutingModule {
};
...
let AddUpdateControlofficePageModule = class AddUpdateControlofficePageModule {
};
...
let AddUpdateControlofficePage = class AddUpdateControlofficePage {
    ...
    InsertControlRoom() {
        ...
        if (self.ValidationCAddRoom()) {
            ...
            self.commonServices.postwithservice("insertCRoom", obj).subscribe((res) => {
    ...
    UpdateControlRoom() {
        ...
        if (self.ValidationCUpdateRoom()) {
            ...
            self.commonServices.loadingPresent();
            self.commonServices.postwithservice("updateCRoom", obj).subscribe((res) => {
                const data = JSON.parse(res);
...
AddUpdateControlofficePage.ctorParameters = () => [
...
//# sourceMappingURL=HO-add-update-controloffice-add-update-controloffice-module-es2015.js.map