...
let OtherSalesPageRoutingModule = class OtherSalesPageRoutingModule {
};
...
let OtherSalesPageModule = class OtherSalesPageModule {
};
...
let OtherSalesPage = class OtherSalesPage {
    constructor(alertController, formBuilder, router, activatedroute, commonServices, menu, dp, modalController) {
    ...
    GetCompanyClusterList() {
        ...
        console.log(obj);
        this.commonServices.post("GetCompanyClusterList", obj).subscribe((resp) => {
...
//# sourceMappingURL=station-other-sales-other-sales-module-es2015.js.map