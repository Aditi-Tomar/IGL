...
var AddUpdateEntryThreshholdPageRoutingModule = /** @class */ (function () {
    function AddUpdateEntryThreshholdPageRoutingModule() {
    }
    ...
    return AddUpdateEntryThreshholdPageRoutingModule;
}());
...
var AddUpdateEntryThreshholdPageModule = /** @class */ (function () {
    function AddUpdateEntryThreshholdPageModule() {
    }
    ...
    return AddUpdateEntryThreshholdPageModule;
}());
...
var AddUpdateEntryThreshholdPage = /** @class */ (function () {
    function AddUpdateEntryThreshholdPage(formBuilder, router, activatedroute, commonServices) {
    ...
    AddUpdateEntryThreshholdPage.prototype.ngAfterContentInit = function () {
        this.addForm;
    };
    AddUpdateEntryThreshholdPage.prototype.ngOnInit = function () {
    };
    AddUpdateEntryThreshholdPage.prototype.InsertThreshold = function () {
        ...
        if (self.validationDisp()) {
            ...
            self.commonServices.post("InsertUpdateEntryThreshold", obj).subscribe(function (res) {
    ...
    AddUpdateEntryThreshholdPage.prototype.validationDisp = function () {
    ...
    AddUpdateEntryThreshholdPage.ctorParameters = function () { return [
    ...
    return AddUpdateEntryThreshholdPage;
}());
...
//# sourceMappingURL=HO-redirected_pages-add-update-entry-threshhold-add-update-entry-threshhold-module-es5.js.map