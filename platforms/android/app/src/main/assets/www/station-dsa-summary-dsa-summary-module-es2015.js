...
let DsaSummaryPageRoutingModule = class DsaSummaryPageRoutingModule {
};
...
let DsaSummaryPageModule = class DsaSummaryPageModule {
};
...
let DsaSummaryPage = class DsaSummaryPage {
    constructor(formBuilder, router, activatedroute, commonServices, menu, dp, modalController) {
    ...
    toggleSideBar() {
        this.commonServices.post("CommonGetData", { Id: this.onselectedStation, Status: this.SummeryDate, Flag: 'validatePopup' }).subscribe((resp) => {
    ...
    GetReadingbyShift() {
        ...
        this.commonServices.post("getSummaryHO", obj).subscribe((resp) => {
            ...
            this.stationName = Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.DispensarTable3[0].StationName) ? '' : this.DispensarTable3[0].StationName;
            this.commonServices.loadingDismiss();
    ...
    checkPendingEntry() {
        ...
        this.commonServices.loadingDismiss();
        this.commonServices.loadingPresent();
        this.commonServices.post("CommonGetData", obj).subscribe((resp) => {
            const data = JSON.parse(resp);
            console.log(data);
            if (data.Table[0].Msg == 'Allow') {
    ...
    DispenserSummarySubmitted() {
        ...
        this.commonServices.DispenserSummarySubmitted(frmData).subscribe((resp) => {
            console.log(JSON.parse(resp));
    ...
    FetchDSASubmittedData() {
        ...
        this.commonServices.FetchDSASubmittedData(objson).subscribe((resp) => {
            var arr = [];
    ...
    CheckShiftSubmitData() {
        this.commonServices.post("CommonGetData", { Id: this.selectedStation, Flag: 'IsShiftEntryComplete',
            Status: this.CdateTime, ReportFlag: this.DepartmentCode }).subscribe((resp) => {
...
//# sourceMappingURL=station-dsa-summary-dsa-summary-module-es2015.js.map