...
var LoginPage = /** @class */ (function () {
    ...
    function LoginPage(navCtrl, formBuilder, router, commonServices, events, menuCtrl) {
    ...
    LoginPage.prototype.doLogin = function () {
        ...
        if (self.loginForm.value.loginid == "") {
            ...
            self.commonServices.post("ValidateUser", loginReq).subscribe(function (res) {
                var loginRes = JSON.parse(res);
                ...
                _this.sideMenuData(loginRes[0].UserId);
                if (loginRes[0].DepartmentCode == "HO") {
                    console.log(loginRes);
    ...
    LoginPage.prototype.GetStationDetail = function () {
        var _this = this;
        var MyJson = { LoginId: this.loginForm.value.loginid };
        this.commonServices.postwithservice("GetStationDetail", MyJson).subscribe(function (resp) {
    ...
    LoginPage.prototype.sideMenuData = function (userID) {
        var _this = this;
        var self = this;
    ...
    Object.defineProperty(LoginPage.prototype, "loginid", {
    ...
    Object.defineProperty(LoginPage.prototype, "employeecode", {
        get: function () {
    ...
    LoginPage.prototype.onKeyPressed = function (event) {
    ...
    LoginPage.prototype.onKeyFocus = function (event) {
        console.log(event);
