...
let JumpReadingPopPage = 
// @ViewChild('myInput') myInputVariable: ElementRef;
class JumpReadingPopPage {
    constructor(router, activatedroute, commonServices, modalController, navCtrl, nativeElement, alertController) {
        this.router = router;
    ...
    UpdateJumpReading(DispanserJumpId, itm) {
    ...
    saveJumpReading() {
        ...
        this.commonServices.SaveJumpReading(frmData).subscribe((resp) => {
            const data = resp;
            console.log(data);
    ...
    GetReadingbyShift() {
        ...
        // this.commonServices.loadingPresent();
        this.commonServices.post("GetReadingbyShift", obj).subscribe((resp) => {
            // this.commonServices.loadingDismiss();
    ...
    DeleteJumpReading(DispanserJumpId, itm) {
...
JumpReadingPopPage.ctorParameters = () => [
...
//# sourceMappingURL=default~jump-reading-pop-jump-reading-pop-module~station-dsa-dispenser-entry-dsa-dispenser-entry-module-es2015.js.map