...
let AddUpdateStationManagementPageRoutingModule = class AddUpdateStationManagementPageRoutingModule {
};
...
let AddUpdateStationManagementPageModule = class AddUpdateStationManagementPageModule {
};
...
let AddUpdateStationManagementPage = class AddUpdateStationManagementPage {
    constructor(datepipe, formBuilder, router, activatedroute, commonServices) {
        ...
        self.commonServices.post("CommonGetData", { Flag: 'SoById', Id: StationId })
            ...
            if (this.stationmlist != "" && this.stationmlist != undefined) {
                this.addForm = this.formBuilder.group({
                    StationId: [this.stationmlist.StationId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationCode: [this.stationmlist.StationCode, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationName: [this.stationmlist.StationName, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationAddress: [this.stationmlist.StationAddress, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationRegionId: [this.stationmlist.StationRegionId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationCompanyId: [this.stationmlist.StationCompanyId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationTypeId: [this.stationmlist.StationTypeId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    MoId: [this.stationmlist.MoId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationLoginId: [this.stationmlist.LoginId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationPassword: [this.stationmlist.StationId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationConfPassword: [this.stationmlist.StationId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ControlRoomId: [this.stationmlist.ControlRoomId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationEmailId: [this.stationmlist.EmailId, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    StationContactNo: [this.stationmlist.ContactNo, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    Status: this.stationmlist.Status,
                    OpeBalance: parseFloat(this.stationmlist.OpeBalance),
                    ShutdownRemark: [this.stationmlist.ShutdownRemark, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ShiftAManagerName: [this.stationmlist.ShiftAManager, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ShiftAManagerContactNo: [this.stationmlist.ShiftAManagerContact, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ShiftBManagerName: [this.stationmlist.ShiftBManager, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ShiftBManagerContactNo: [this.stationmlist.ShiftBManagerContact, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ShiftCManagerName: [this.stationmlist.ShiftCManager, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ShiftCManagerContactNo: [this.stationmlist.ShiftCManagerContact, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ShiftDManagerName: [this.stationmlist.ShiftDManager, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                    ShiftDManagerContactNo: [this.stationmlist.ShiftDManagerContact, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                });
    ...
    Insertstation() {
        ...
        if (self.validationSO()) {
            ...
            self.commonServices.loadingPresent();
            self.commonServices.post("SOInsertUpdate", obj).subscribe((res) => {
...
AddUpdateStationManagementPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-add-update-station-management-add-update-station-management-module-es2015.js.map