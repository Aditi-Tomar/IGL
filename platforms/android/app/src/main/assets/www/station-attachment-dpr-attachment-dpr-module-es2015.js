...
let AttachmentDprPageRoutingModule = class AttachmentDprPageRoutingModule {
};
...
let AttachmentDprPageModule = class AttachmentDprPageModule {
};
...
let AttachmentDprPage = class AttachmentDprPage {
    constructor(alertController, formBuilder, router, activatedroute, commonServices, menu, modalController, camera, actionSheetController, file, transfer, dp, platform, fileOpener, document) {
    ...
    saveAttachment(imageURI) {
        ...
        self.commonServices.loadingDismiss();
        self.commonServices.udpateAttachment(frmData).subscribe((resp) => {
...
AttachmentDprPage.ctorParameters = () => [
...
//# sourceMappingURL=station-attachment-dpr-attachment-dpr-module-es2015.js.map