...
let ForgetPasswordPage = class ForgetPasswordPage {
    constructor(formBuilder, router, activatedroute, commonServices, menuCtrl) {
    ...
    forgotPassword() {
        ...
        if (self.stationId == '') {
            ...
            self.commonServices.postwithservice("forgotPassword", { Id: this.stationId }).subscribe((res) => {
