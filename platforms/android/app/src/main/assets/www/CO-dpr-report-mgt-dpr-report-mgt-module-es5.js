...
var DprReportMgtPageRoutingModule = /** @class */ (function () {
    function DprReportMgtPageRoutingModule() {
    }
    ...
    return DprReportMgtPageRoutingModule;
}());
...
var DprReportMgtPageModule = /** @class */ (function () {
    function DprReportMgtPageModule() {
    }
...
var DprReportMgtPage = /** @class */ (function () {
    function DprReportMgtPage(formBuilder, router, activatedroute, datepipe, commonServices, menu) {
    ...
    DprReportMgtPage.prototype.ngOnInit = function () {
    };
    DprReportMgtPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuCO');
        this.menu.open('menuCO');
    };
    DprReportMgtPage.prototype.OnDateChnagefrom = function (val) {
        var self = this;
        var dt = new Date(val);
    ...
    DprReportMgtPage.prototype.OnDateChnageTo = function (val) {
        var self = this;
        var dt = new Date(val);
        //IOS Comment
    ...
    DprReportMgtPage.prototype.OnReportChnage = function (evt) {
        var self = this;
    ...
    DprReportMgtPage.prototype.onRegionSelect = function (val) {
        var self = this;
        ...
        if (self.selectedRegion != "All") {
            ...
            self.commonServices.postwithservice("GetStationsByAdmin", { ControlRoomCode: self.ControlRoomCode,
                Region: self.selectedRegion, Flag: self.ReportFlag }).subscribe(function (resp) {
    ...
    DprReportMgtPage.prototype.GetRegionByDept = function () {
        var _this = this;
        var self = this;
        // self.commonServices.loadingPresent();
        self.commonServices.postwithservice("GetDashBoardCO", { LoginId: self.ControlRoomCode }).subscribe(function (response) {
            var data = JSON.parse(response);
            console.log(data);
            var data2 = data;
            if (data2.Table1.length > 0) {
                self.RegionList = data2.Table1;
                console.log(_this.RegionList, "RegionlistDpr");
            }
    ...
    DprReportMgtPage.prototype.onStationSelect = function (val) {
        var self = this;
        self.selectedStation = val;
    };
    DprReportMgtPage.prototype.GetExportDPRreports = function () {
        var self = this;
        if (this.ValidationReports()) {
            ...
            if (self.selectedReport == "DPR") {
                self.commonServices.loadingPresent();
                self.commonServices.postwithservice("DprExcel", obj).subscribe(function (resp) {
                ...
                if (self.dateFrom != null && self.dateTo != null) {
                    self.commonServices.postwithservice("ExportPendingStation", obj).subscribe(function (resp) {
                        var data = JSON.parse(resp);
                        if (data.FileName != '') {
                            if (JSON.parse(resp).errMsg == 'success') {
                                window.location.href = self.commonServices.apiImageAttachment + "/Attachments/Excel/" + JSON.parse(resp).FileName;
                ...
                if (self.dateFrom != null && self.dateTo != null) {
                    self.commonServices.loadingPresent();
                    self.commonServices.postwithservice("ExportGetOpeningClosing", obj).subscribe(function (resp) {
                        var data = JSON.parse(resp);
                ...
                if (self.dateFrom != null && self.dateTo != null) {
                    self.commonServices.loadingPresent();
                    self.commonServices.postwithservice("ExportRemarkHistory", obj).subscribe(function (resp) {
                        var data = JSON.parse(resp);
                ...
                if (self.dateFrom != null && self.dateTo != null) {
                    self.commonServices.loadingPresent();
                    self.commonServices.postwithservice("ExportRejectStationHistory", obj).subscribe(function (resp) {
                        var data = JSON.parse(resp);
                ...
                if (self.dateFrom != null && self.dateTo != null) {
                    self.commonServices.loadingPresent();
                    self.commonServices.postwithservice("ExportJumpReport", obj).subscribe(function (resp) {
                        var data = JSON.parse(resp);
                ...
                if (self.dateFrom != null && self.dateTo != null) {
                    self.commonServices.loadingPresent();
                    self.commonServices.postwithservice("ExportJMRReport", obj).subscribe(function (resp) {
                        var data = JSON.parse(resp);
                ...
                if (self.dateFrom != null && self.dateTo != null) {
                    self.commonServices.loadingPresent();
                    self.commonServices.postwithservice("ExportDPRSubmissionReport", obj).subscribe(function (resp) {
                        var data = JSON.parse(resp);
                ...
                if (self.dateFrom != null && self.dateTo != null) {
                    self.commonServices.loadingPresent();
                    self.commonServices.postwithservice("ExportCRSubmissionReport", obj).subscribe(function (resp) {
                        var data = JSON.parse(resp);
    ...
    DprReportMgtPage.prototype.ValidationReports = function () {
        var self = this;
        this.errorFound = true;
    ...
    DprReportMgtPage.prototype.checkdifference = function (dateFrom, dateTo) {
        var self = this;
    ...
    DprReportMgtPage.ctorParameters = function () { return [
...
//# sourceMappingURL=CO-dpr-report-mgt-dpr-report-mgt-module-es5.js.map