...
let LcvPage = class LcvPage {
    ...
    getLcvList() {
        ...
        self.commonServices.postwithservice("GetLcvMaster", { Status: self.DSStatus }).subscribe((res) => {
    ...
    exportFile() {
        this.commonServices.post("getAllDetails_CSV", { status: this.DSStatus, PageFlag: 'LCV' }).subscribe((resp) => {
...
//# sourceMappingURL=HO-lcv-lcv-module-es2015.js.map