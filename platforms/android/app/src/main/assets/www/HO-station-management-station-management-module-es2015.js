...
let StationManagementPageRoutingModule = class StationManagementPageRoutingModule {
};
...
let StationManagementPageModule = class StationManagementPageModule {
};
...
let StationManagementPage = class StationManagementPage {
    ...
    getStationMList() {
        ...
        self.commonServices.post("CommonGetData", { Flag: 'SOList', Id: '0', Status: self.DSStatus }).subscribe((res) => {
    ...
    exportFile() {
        this.commonServices.post("getAllDetails_CSV", { Flag: 'SOList', Id: '0', Status: this.DSStatus, PageFlag: 'StationMaster' }).subscribe((resp) => {
...
StationManagementPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-station-management-station-management-module-es2015.js.map