...
let GasGensetPage = class GasGensetPage {
    ...
    getGassetList() {
        ...
        self.commonServices.postwithservice("GetGensetMaster", { Flag: 'AlluserDetsils', Status: self.DSStatus }).subscribe((res) => {
    ...
    exportFile() {
        this.commonServices.post("getAllDetails_CSV", { status: this.DSStatus, PageFlag: 'GasGenset' }).subscribe((resp) => {
...
//# sourceMappingURL=HO-gas-genset-gas-genset-module-es2015.js.map