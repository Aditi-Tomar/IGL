...
var AttachmentDsaPageRoutingModule = /** @class */ (function () {
    function AttachmentDsaPageRoutingModule() {
    }
    ...
    return AttachmentDsaPageRoutingModule;
}());
...
var AttachmentDsaPageModule = /** @class */ (function () {
    function AttachmentDsaPageModule() {
    }
    ...
    return AttachmentDsaPageModule;
}());
...
var AttachmentDsaPage = /** @class */ (function () {
    function AttachmentDsaPage(alertController, formBuilder, router, activatedroute, commonServices, menu, dp, modalController, camera, platform, fileOpener, document, actionSheetController, file, transfer) {
    ...
    AttachmentDsaPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AttachmentDsaPage.prototype.presentModal = function () {
    ...
    AttachmentDsaPage.prototype.presentModal1 = function (attachment) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AttachmentDsaPage.prototype.openFirst = function () {
    ...
    AttachmentDsaPage.prototype.searchCollapse = function () {
    ...
    AttachmentDsaPage.prototype.hideSearchBar = function () {
        this.searchShow = false;
        this.searchFlag = 0;
    };
    AttachmentDsaPage.prototype.OnDateChnageFrom = function (val) {
        var self = this;
        var dt = new Date(val);
    ...
    AttachmentDsaPage.prototype.OnDateChnageTo = function (val) {
        var self = this;
        var dt = new Date(val);
        //IOS Comment
    ...
    AttachmentDsaPage.prototype.getSelectedDate = function (datePicker) {
    ...
    AttachmentDsaPage.prototype.getData = function () {
    ...
    AttachmentDsaPage.prototype.getItems = function (ev) {
        var val = ev.target.value;
        if (val && val.trim() != '') {
            this.isItemAvailable = true;
            this.items = this.listDispAttachments.filter(function (item) {
                return (item.DispenserName.toLowerCase().indexOf(val.toLowerCase()) > -1);
            });
            console.log(this.items);
        }
    };
    AttachmentDsaPage.prototype.selectImage = function (item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var self, actionSheet;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
                        this.JumpReadingId = item.DispanserJumpId;
                        return [4 /*yield*/, self.actionSheetController.create({
    ...
    AttachmentDsaPage.prototype.pickImage = function (sourceType) {
        var _this = this;
        var self = this;
        var options = {
            quality: 100,
        ...
        self.camera.getPicture(options).then(function (imageData) {
            ...
            // });
            _this.file.resolveLocalFilesystemUrl(imageData.filePath).then(function (entry) {
    ...
    AttachmentDsaPage.prototype.readFile = function (file) {
        var _this = this;
        var self = this;
        ...
        reader.onloadend = function () {
            ...
            formData.append('JumpReadingId', _this.JumpReadingId);
            formData.append('Image', imgBlob, file.name);
            self.commonServices.uploadAttachment(formData).subscribe(function (dataRes) {
    ...
    AttachmentDsaPage.prototype.saveAttachment = function (imageURI) {
        var self = this;
        ...
        self.commonServices.loadingPresent();
        self.commonServices.uploadAttachment(frmData).subscribe(function (resp) {
    ...
    AttachmentDsaPage.prototype.GenerateJumpCertificate = function (item) {
        var _this = this;
    ...
    AttachmentDsaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=station-attachment-dsa-attachment-dsa-module-es5.js.map