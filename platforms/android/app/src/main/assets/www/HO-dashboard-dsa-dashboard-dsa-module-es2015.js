...
let DashboardDsaPageRoutingModule = class DashboardDsaPageRoutingModule {
};
...
let DashboardDsaPageModule = class DashboardDsaPageModule {
};
...
let DashboardDsaPage = class DashboardDsaPage {
    constructor(router, commonServices, datepipe, menu) {
        this.router = router;
...
DashboardDsaPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-dashboard-dsa-dashboard-dsa-module-es2015.js.map