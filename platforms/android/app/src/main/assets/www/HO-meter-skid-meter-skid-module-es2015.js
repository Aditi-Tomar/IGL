...
let MeterSkidPage = class MeterSkidPage {
    ...
    getMeterSkidList() {
        ...
        self.commonServices.postwithservice("GetMeterSkidMaster", { Status: self.DSStatus }).subscribe((res) => {
    ...
    exportFile() {
        this.commonServices.post("getAllDetails_CSV", { status: this.DSStatus, PageFlag: 'MeterSkid' }).subscribe((resp) => {
...
//# sourceMappingURL=HO-meter-skid-meter-skid-module-es2015.js.map