...
let ControlOfficePageRoutingModule = class ControlOfficePageRoutingModule {
};
...
let ControlOfficePageModule = class ControlOfficePageModule {
};
...
let ControlOfficePage = class ControlOfficePage {
    ...
    getControlOfficeList() {
        ...
        self.commonServices.postwithservice("getCRooms", {}).subscribe((res) => {
...
ControlOfficePage.ctorParameters = () => [
...
//# sourceMappingURL=HO-control-office-control-office-module-es2015.js.map