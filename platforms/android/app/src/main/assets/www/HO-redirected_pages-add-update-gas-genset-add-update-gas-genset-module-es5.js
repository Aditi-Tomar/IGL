...
var AddUpdateGasGensetPageRoutingModule = /** @class */ (function () {
    function AddUpdateGasGensetPageRoutingModule() {
    }
    ...
    return AddUpdateGasGensetPageRoutingModule;
}());
...
var AddUpdateGasGensetPageModule = /** @class */ (function () {
    function AddUpdateGasGensetPageModule() {
    }
    ...
    return AddUpdateGasGensetPageModule;
}());
...
var AddUpdateGasGensetPage = /** @class */ (function () {
    function AddUpdateGasGensetPage(formBuilder, router, activatedroute, commonServices) {
    ...
    AddUpdateGasGensetPage.prototype.ngAfterContentInit = function () {
        this.updateGset();
    };
    AddUpdateGasGensetPage.prototype.ngOnInit = function () {
        this.gsetlist = JSON.parse(this.activatedroute.snapshot.paramMap.get('gsetlist'));
        this.getStationList();
    };
    AddUpdateGasGensetPage.prototype.updateGset = function () {
        var self = this;
    ...
    AddUpdateGasGensetPage.prototype.getStationList = function () {
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.postwithservice("GetGensetMaster", { Status: "" }).subscribe(function (res) {
    ...
    AddUpdateGasGensetPage.prototype.insertUpdateData = function () {
        var self = this;
        var statusToggle = 1;
        ...
        if (self.pageFlag == "updatepage") {
            ...
            if (self.ValidationGenSet()) {
                self.commonServices.loadingPresent();
                self.commonServices.postwithservice("updateGensetMaster", self.obj).subscribe(function (res) {
            ...
            if (self.ValidationGenSet()) {
                self.commonServices.loadingPresent();
                self.commonServices.postwithservice("insertGensetMaster", self.obj).subscribe(function (res) {
                    self.gsetRes = (JSON.parse(res));
                    console.log(self.gsetRes);
    ...
    AddUpdateGasGensetPage.prototype.ValidationGenSet = function () {
    ...
    AddUpdateGasGensetPage.prototype.filterBoxShow = function (itm) {
    ...
    AddUpdateGasGensetPage.prototype.onSearchTerm = function (ev) {
    ...
    AddUpdateGasGensetPage.ctorParameters = function () { return [
...
//# sourceMappingURL=HO-redirected_pages-add-update-gas-genset-add-update-gas-genset-module-es5.js.map