...
let AddUpdateRateMgtPageRoutingModule = class AddUpdateRateMgtPageRoutingModule {
};
...
let AddUpdateRateMgtPageModule = class AddUpdateRateMgtPageModule {
};
...
let AddUpdateRateMgtPage = class AddUpdateRateMgtPage {
    ...
    GetCdate() {
        var self = this;
        self.commonServices.post("CommonGetData", { Flag: 'Cdate', Id: 0 }).subscribe((res) => {
    ...
    insertUpdateData() {
        ...
        if (self.ValidationRate()) {
            self.commonServices.loadingPresent();
            self.commonServices.post("RateMaster", self.obj).subscribe((res) => {
...
AddUpdateRateMgtPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-redirected_pages-add-update-rate-mgt-add-update-rate-mgt-module-es2015.js.map