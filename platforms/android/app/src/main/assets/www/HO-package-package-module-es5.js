...
var PackagePage = /** @class */ (function () {
    function PackagePage(router, commonServices, menu) {
        this.router = router;
    ...
    PackagePage.prototype.segmentChanged = function (value) {
        console.log(value);
    ...
    PackagePage.prototype.getPackageList = function () {
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.postwithservice("GetPackageMaster", { Status: self.DSStatus }).subscribe(function (res) {
    ...
    PackagePage.prototype.hideSearchBar = function () {
        this.searchShow = false;
        this.searchFlag = 0;
    };
    PackagePage.prototype.getItems = function (ev) {
        ...
        if (val && val.trim() != '') {
            ...
            this.items = this.PackageList.filter(function (item) {
                return (item.StationCode.toLowerCase().indexOf(val.toLowerCase()) > -1);
            });
            console.log(this.items);
        }
    };
    PackagePage.prototype.exportFile = function () {
        var _this = this;
        this.commonServices.post("getAllDetails_CSV", { status: this.DSStatus, PageFlag: 'Package' }).subscribe(function (resp) {
...
//# sourceMappingURL=HO-package-package-module-es5.js.map