...
let GasGensetPageRoutingModule = class GasGensetPageRoutingModule {
};
...
let GasGensetPageModule = class GasGensetPageModule {
};
...
let GasGensetPage = class GasGensetPage {
    ...
    GensetuploadJumpReadingImg(str) {
        this.GSuploadedfile = str.target.files[0];
    }
    Gensetfileuploadreset(str) {
    ...
    InsertGenSetDetails() {
        ...
        if (ErrorMsg == '' || ErrorMsg == undefined) {
            if (Number(this.GSmeterTotaliser) <= Number(this.PreviousReading)) {
                this.commonServices.alertMessage("Confirm", "Suspected Flow Meter Reading, Do you want to continue?").then((res) => {
                    console.log(res);
                    // if (confirm("Suspected Flow Meter Reading, Do you want to continue?")) {
                    if (!res) {
                        this.commonServices.loadingPresent();
                        this.commonServices.InsertGenSetDetails(frmData).subscribe((resp) => {
                            this.commonServices.loadingDismiss();
                            const data = resp;
                            console.log(data);
                ...
                this.commonServices.alertMessage("Confirm", "Wrong Entry for Flow Meter Reading, Do you want to continue?").then((res) => {
                    console.log(res);
                    if (!res) {
                        this.commonServices.loadingPresent();
                        this.commonServices.InsertGenSetDetails(frmData).subscribe((resp) => {
    ...
    DeleteGSIJumpHistory(Id, FlagReading, itm) {
...
//# sourceMappingURL=station-gas-genset-gas-genset-module-es2015.js.map