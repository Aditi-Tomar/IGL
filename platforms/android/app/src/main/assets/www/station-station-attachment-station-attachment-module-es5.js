...
var StationAttachmentPageRoutingModule = /** @class */ (function () {
    function StationAttachmentPageRoutingModule() {
    }
    ...
    return StationAttachmentPageRoutingModule;
}());
...
var StationAttachmentPageModule = /** @class */ (function () {
    function StationAttachmentPageModule() {
    }
    ...
    return StationAttachmentPageModule;
}());
...
var StationAttachmentPage = /** @class */ (function () {
    function StationAttachmentPage(modalController, router, activatedroute, commonServices, menu, dp, alertController) {
    ...
    StationAttachmentPage.prototype.ngOnInit = function () {
        this.GetStationAttachmentList();
        this.ExpiryDate = new Date().toLocaleDateString();
    };
    StationAttachmentPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuStn');
        this.menu.open('menuStn');
    };
    StationAttachmentPage.prototype.presentModal = function (attachment) {
    ...
    StationAttachmentPage.prototype.fileuploadreset = function (str) {
        this.uploadedfilereset = str.target.files[0];
    };
    StationAttachmentPage.prototype.OnDateChnage = function (val) {
        this.ExpiryDate = new Date(val).toLocaleDateString();
        console.log("ExpiryDate", this.ExpiryDate);
    };
    StationAttachmentPage.prototype.Readingvalue = function (value) {
        this.Reading = value;
        if (this.Reading != '') {
    ...
    StationAttachmentPage.prototype.DeleteStationAttachment = function (Id, itm) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        _this.commonServices.post("DeleteStationAttachmentById", Json).subscribe(function (resp) {
                                            var data = JSON.parse(resp);
                                            _this.commonServices.presentToast(data.Table[0].Status);
                                            _this.GetStationAttachmentList();
                                            _this.Clear();
    ...
    StationAttachmentPage.prototype.ViewStationAttachment = function (Path, itm) {
    ...
    StationAttachmentPage.prototype.CheckExtn = function (Path, itm) {
    ...
    StationAttachmentPage.prototype.GetStationAttachmentList = function () {
        var _this = this;
        var obj = {
        ...
        this.commonServices.post("GetStationAttachmentList", obj).subscribe(function (resp) {
            _this.StationAttachmentList = JSON.parse(resp).Table;
            console.log(_this.StationAttachmentList);
            _this.commonServices.loadingDismiss();
        }, function (error) {
            _this.commonServices.presentToast("Something went wrong.");
            _this.commonServices.loadingDismiss();
    ...
    StationAttachmentPage.prototype.UpdateStationAttachment = function (Id, itm) {
    ...
    StationAttachmentPage.prototype.OnSubmit = function () {
        var _this = this;
        var MyJsonreset = {
            StationId: this.StationId,
            flag: this.flag,
        ...
        if (ErrorMsg == '' || ErrorMsg == undefined) {
            this.commonServices.StationAttachment(frmData).subscribe(function (resp) {
                var data = (resp);
    ...
    StationAttachmentPage.prototype.changeresetValidation = function (StationAttachment) {
    ...
    StationAttachmentPage.prototype.Clear = function () {
        this.StationAttachmentId = '0';
        this.Reading = '';
        this.ExpiryDate = new Date().toLocaleDateString();
        this.DocumentName = '';
    ...
    StationAttachmentPage.ctorParameters = function () { return [
...
//# sourceMappingURL=station-station-attachment-station-attachment-module-es5.js.map