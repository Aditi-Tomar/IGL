...
let SoDashboardPageRoutingModule = class SoDashboardPageRoutingModule {
};
...
let SoDashboardPageModule = class SoDashboardPageModule {
};
...
let SoDashboardPage = class SoDashboardPage {
    constructor(menu, router, dp) {
        this.menu = menu;
        this.router = router;
        this.dp = dp;
...
SoDashboardPage.ctorParameters = () => [
...
//# sourceMappingURL=SO-so-dashboard-so-dashboard-module-es2015.js.map