...
let AddApdatePackagePageRoutingModule = class AddApdatePackagePageRoutingModule {
};
...
let AddApdatePackagePageModule = class AddApdatePackagePageModule {
};
...
let AddApdatePackagePage = class AddApdatePackagePage {
    ...
    getStationList() {
        ...
        self.commonServices.postwithservice("GetPackageMaster", { Status: "" }).subscribe((res) => {
    ...
    insertUpdatepack() {
        ...
        if (self.pageFlag == "updatepage") {
            ...
            if (self.ValidationCRoom()) {
                self.commonServices.loadingPresent();
                self.commonServices.postwithservice("updatePackageMaster", self.obj).subscribe((res) => {
            ...
            if (self.ValidationCRoom()) {
                self.commonServices.loadingPresent();
                self.commonServices.postwithservice("insertPackageMaster", self.obj).subscribe((res) => {
                    self.packRes = (JSON.parse(res));
                    console.log(self.packRes);
...
AddApdatePackagePage.ctorParameters = () => [
...
//# sourceMappingURL=HO-redirected_pages-add-apdate-package-add-apdate-package-module-es2015.js.map