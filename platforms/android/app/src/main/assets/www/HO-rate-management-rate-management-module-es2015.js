...
let RateManagementPageRoutingModule = class RateManagementPageRoutingModule {
};
...
let RateManagementPageModule = class RateManagementPageModule {
};
...
let RateManagementPage = class RateManagementPage {
    ...
    saveRate(rateId, regionId, effectiveDate, normalRate, discountRate, displayRate) {
        ...
        if (this.ValidationRate()) {
            ...
            self.commonServices.post("RateMaster", obj).subscribe((resp) => {
...
RateManagementPage.ctorParameters = () => [
...
//# sourceMappingURL=HO-rate-management-rate-management-module-es2015.js.map