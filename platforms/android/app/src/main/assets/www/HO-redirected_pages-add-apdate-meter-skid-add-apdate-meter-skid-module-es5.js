...
var AddApdateMeterSkidPageRoutingModule = /** @class */ (function () {
    function AddApdateMeterSkidPageRoutingModule() {
    }
    ...
    return AddApdateMeterSkidPageRoutingModule;
}());
...
var AddApdateMeterSkidPageModule = /** @class */ (function () {
    function AddApdateMeterSkidPageModule() {
    }
    ...
    return AddApdateMeterSkidPageModule;
}());
...
var AddApdateMeterSkidPage = /** @class */ (function () {
    function AddApdateMeterSkidPage(formBuilder, router, activatedroute, commonServices) {
    ...
    AddApdateMeterSkidPage.prototype.ngAfterContentInit = function () {
        this.updatemskid();
    };
    AddApdateMeterSkidPage.prototype.ngOnInit = function () {
        this.mskidlist = JSON.parse(this.activatedroute.snapshot.paramMap.get('mskidlist'));
        this.getMeterstationList();
    };
    AddApdateMeterSkidPage.prototype.updatemskid = function () {
        var self = this;
    ...
    AddApdateMeterSkidPage.prototype.getMeterstationList = function () {
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.postwithservice("GetMeterSkidMaster", { Status: "" }).subscribe(function (res) {
    ...
    AddApdateMeterSkidPage.prototype.insertUpdateMeterSkid = function () {
        var self = this;
        var statusToggle = 1;
        ...
        if (self.pageFlag == "updatemkid") {
            ...
            if (self.ValidationMeterSkid()) {
                self.commonServices.loadingPresent();
                self.commonServices.postwithservice("updateMeterSkidMaster", self.obj).subscribe(function (res) {
            ...
            if (self.ValidationMeterSkid()) {
                self.commonServices.loadingPresent();
                self.commonServices.postwithservice("insertMeterSkidMaster", self.obj).subscribe(function (res) {
                    self.mskidRes = (JSON.parse(res));
                    console.log(self.mskidRes);
    ...
    AddApdateMeterSkidPage.prototype.ValidationMeterSkid = function () {
    ...
    AddApdateMeterSkidPage.prototype.filterBoxShow = function (itm) {
    ...
    AddApdateMeterSkidPage.prototype.onSearchTerm = function (ev) {
    ...
    AddApdateMeterSkidPage.ctorParameters = function () { return [
...
//# sourceMappingURL=HO-redirected_pages-add-apdate-meter-skid-add-apdate-meter-skid-module-es5.js.map