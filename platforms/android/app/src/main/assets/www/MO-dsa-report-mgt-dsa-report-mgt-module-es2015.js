...
let DsaReportMgtPageRoutingModule = class DsaReportMgtPageRoutingModule {
};
...
let DsaReportMgtPageModule = class DsaReportMgtPageModule {
};
...
let DsaReportMgtPage = class DsaReportMgtPage {
    ...
    RegionByDept() {
        ...
        self.commonServices.post("CommonGetData", { Flag: 'StationSubmittedStatusForMO', Id: self.UserId }).subscribe((res) => {
    ...
    onReportSelect() {
        ...
        if (self.ValidationReports()) {
            ...
            if (self.IsStationPending == true && self.selectedReport == "PENDING STATIONS") {
                self.commonServices.post("ExcelExportDSA", obj).subscribe((resp) => {
                ...
                self.commonServices.post("ExportDSASubmissionReport", obj).subscribe((resp) => {
                    console.log(resp);
                    if (JSON.parse(resp).errMsg == 'success') {
                ...
                self.commonServices.post("ExportSOPSubmissionReport", obj).subscribe((resp) => {
                    if (JSON.parse(resp).errMsg == 'success') {
                        window.location.href = self.commonServices.apiImageAttachment + "/Attachments/Excel/" +
                            JSON.parse(resp).FileName;
                        self.commonServices.loadingDismiss();
                    ...
                    if (self.dateFrom != null && self.dateTo != null && self.selectedReport != null && self.selectedReport != "") //&& this.selectRegion != null
                     {
                        ...
                        self.commonServices.post("ExcelExportCashRecon", obj).subscribe((resp) => {
    ...
    onRegionSelect(val, CompanyId) {
        ...
        if (self.selectRegion != "All") {
            ...
            self.commonServices.post("CommonGetData", {
                ...
                if (self.selectCompany == '' || Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(this.selectCompany)) {
                    self.GetCompany();
                    console.log('inner');
                }
                else
    ...
    GetCompany() {
        ...
        if (self.selectCompany != "All") {
            ...
            self.commonServices.post("CommonGetData", { Id: 0, Flag: 'CompanyByRegion', Status: '',
                RegionId: this.selectRegion }).subscribe((resp) => {
    ...
    onReportSelectSec() {
        ...
        if (self.dateFromSec != null) {
            self.commonServices.loadingPresent();
            self.commonServices.post("ExcelExportDSASec", obj).subscribe((resp) => {
                if (JSON.parse(resp).errMsg == 'success') {
                    window.location.href = self.commonServices.apiImageAttachment + "/Attachments/Excel/" + JSON.parse(resp).FileName;
                }
                else {
...
DsaReportMgtPage.ctorParameters = () => [
...
//# sourceMappingURL=MO-dsa-report-mgt-dsa-report-mgt-module-es2015.js.map