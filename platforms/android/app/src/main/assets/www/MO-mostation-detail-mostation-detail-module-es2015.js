...
let MOStationDetailPageRoutingModule = class MOStationDetailPageRoutingModule {
};
...
let MOStationDetailPageModule = class MOStationDetailPageModule {
};
...
let MOStationDetailPage = class MOStationDetailPage {
    ...
    updateStatus(i, StationId, event) {
        ...
        this.commonServices.alertMessage("Confirm", "Do you want to change the status?").then((res) => {
            ...
            if (!res) {
                ...
                self.commonServices.post("CommonGetData", { Flag: 'UpdateSOStatus', Id: StationId, Status: this.status }).subscribe((res) => {
    ...
    getMoStationData() {
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.post("CommonGetData", { Flag: 'SOListForMO', Id: self.userId }).subscribe((res) => {
    ...
    exportFile() {
        this.commonServices.post("getAllDetails_CSV", { Flag: "SOListForMO", Id: this.userId, PageFlag: 'MOStations', Status: this.status }).subscribe((resp) => {
...
MOStationDetailPage.ctorParameters = () => [
...
//# sourceMappingURL=MO-mostation-detail-mostation-detail-module-es2015.js.map