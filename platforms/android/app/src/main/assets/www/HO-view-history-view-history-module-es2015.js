...
let ViewHistoryPage = class ViewHistoryPage {
    ...
    GetDispHistory() {
        ...
        self.commonServices.post("CommonGetData", { Flag: 'DispenserHistory', Id: self.DispId, Status: 0 }).subscribe((res) => {
...
//# sourceMappingURL=HO-view-history-view-history-module-es2015.js.map