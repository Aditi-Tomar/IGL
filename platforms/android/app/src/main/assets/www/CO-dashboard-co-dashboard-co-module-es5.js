...
var DashboardCOPageRoutingModule = /** @class */ (function () {
    function DashboardCOPageRoutingModule() {
    }
    ...
    return DashboardCOPageRoutingModule;
}());
...
var DashboardCOPageModule = /** @class */ (function () {
    function DashboardCOPageModule() {
    }
...
var DashboardCOPage = /** @class */ (function () {
    function DashboardCOPage(router, commonServices, menu) {
        this.router = router;
    ...
    DashboardCOPage.prototype.ngOnInit = function () {
    };
    DashboardCOPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuCO');
        this.menu.open('menuCO');
    };
    DashboardCOPage.prototype.getDashoardCo = function () {
        var _this = this;
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.postwithservice("GetDashBoardCO", { LoginId: self.LoginId }).subscribe(function (res) {
            ...
            if (data != '') {
                ...
                if (data2.Table.length > 0) {
                    ...
                    _this.dashboardData = _this.datashnoardcoRes;
                }
                else {
    ...
    DashboardCOPage.prototype.showStationCode = function (stname) {
        var item = this.dashboardData.filter(function (item) { return item.StationName === stname; });
        console.log("station code", item);
        this.stationCode = item[0].StationCode;
        this.stationname = item[0].StationName;
        this.isShown = !this.isShown;
    };
    DashboardCOPage.ctorParameters = function () { return [
...
//# sourceMappingURL=CO-dashboard-co-dashboard-co-module-es5.js.map