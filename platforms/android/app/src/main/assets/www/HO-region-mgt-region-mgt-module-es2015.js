...
let RegionMgtPageRoutingModule = class RegionMgtPageRoutingModule {
};
...
let RegionMgtPageModule = class RegionMgtPageModule {
};
...
let RegionMgtPage = class RegionMgtPage {
    ...
    getRegionList() {
        ...
        self.commonServices.post("CommonGetData", RegionListReq).subscribe((res) => {
...
//# sourceMappingURL=HO-region-mgt-region-mgt-module-es2015.js.map