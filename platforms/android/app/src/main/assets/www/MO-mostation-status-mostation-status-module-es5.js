...
var MOStationStatusPageRoutingModule = /** @class */ (function () {
    function MOStationStatusPageRoutingModule() {
    }
    ...
    return MOStationStatusPageRoutingModule;
}());
...
var MOStationStatusPageModule = /** @class */ (function () {
    function MOStationStatusPageModule() {
    }
    ...
    return MOStationStatusPageModule;
}());
...
var MOStationStatusPage = /** @class */ (function () {
    function MOStationStatusPage(router, activateRoute, commonServices, menu) {
        this.router = router;
    ...
    MOStationStatusPage.prototype.ngOnInit = function () {
    };
    MOStationStatusPage.prototype.searchCollapse = function () {
    ...
    MOStationStatusPage.prototype.hideSearchBar = function () {
        this.searchShow = false;
        this.searchFlag = 0;
    };
    MOStationStatusPage.prototype.getSO = function () {
        var self = this;
    ...
    MOStationStatusPage.prototype.getItems = function (ev) {
    ...
    MOStationStatusPage.ctorParameters = function () { return [
...
//# sourceMappingURL=MO-mostation-status-mostation-status-module-es5.js.map