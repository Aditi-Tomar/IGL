...
var DispenserManagementPageRoutingModule = /** @class */ (function () {
    function DispenserManagementPageRoutingModule() {
    }
    ...
    return DispenserManagementPageRoutingModule;
}());
...
var DispenserManagementPageModule = /** @class */ (function () {
    function DispenserManagementPageModule() {
    }
    ...
    return DispenserManagementPageModule;
}());
...
var DispenserManagementPage = /** @class */ (function () {
    function DispenserManagementPage(router, commonServices, menu) {
        this.router = router;
    ...
    DispenserManagementPage.prototype.ngOnInit = function () {
        this.getDispenserList();
    };
    DispenserManagementPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuCO');
        this.menu.open('menuCO');
    };
    DispenserManagementPage.prototype.segmentChanged = function (value) {
        console.log(value);
    ...
    DispenserManagementPage.prototype.getDispenserList = function () {
        var self = this;
    ...
    DispenserManagementPage.prototype.getItems = function (ev) {
        ...
        if (val && val.trim() != '') {
            ...
            this.items = this.DispenserResList.filter(function (item) {
                return (item.DispenserName.toLowerCase().indexOf(val.toLowerCase()) > -1);
            });
            console.log(this.items);
        }
    };
    DispenserManagementPage.prototype.goToaddDispenser = function () {
        this.router.navigate(['add-update-dispenser-mgt', { pageFlag: "addds" }]);
    };
    DispenserManagementPage.prototype.goToupdateDispenser = function (item) {
        this.router.navigate(['add-update-dispenser-mgt', { dispId: item, pageFlag: "updateds" }]);
    };
    DispenserManagementPage.prototype.viewHistory = function (id) {
        this.router.navigate(['view-history', { dispId: id }]);
    };
    DispenserManagementPage.prototype.searchCollapse = function () {
    ...
    DispenserManagementPage.prototype.hideSearchBar = function () {
        this.searchShow = false;
        this.searchFlag = 0;
    };
    DispenserManagementPage.prototype.exportFile = function () {
        var _this = this;
        this.commonServices.post("getAllDetails_CSV", { Flag: "DispenserList", PageFlag: 'DispenserMaster', Status: this.DSStatus, }).subscribe(function (resp) {
    ...
    DispenserManagementPage.ctorParameters = function () { return [
    ...
    return DispenserManagementPage;
}());
...
//# sourceMappingURL=HO-dispenser-management-dispenser-management-module-es5.js.map