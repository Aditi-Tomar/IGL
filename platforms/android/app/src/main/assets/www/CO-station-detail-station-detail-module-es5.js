...
var StationDetailPageRoutingModule = /** @class */ (function () {
    function StationDetailPageRoutingModule() {
    }
    ...
    return StationDetailPageRoutingModule;
}());
...
var StationDetailPageModule = /** @class */ (function () {
    function StationDetailPageModule() {
    }
    ...
    return StationDetailPageModule;
}());
...
var StationDetailPage = /** @class */ (function () {
    function StationDetailPage(router, commonServices, menu) {
        this.router = router;
    ...
    StationDetailPage.prototype.ngOnInit = function () {
    };
    StationDetailPage.prototype.openFirst = function () {
        this.menu.enable(true, 'menuCO');
        this.menu.open('menuCO');
    };
    StationDetailPage.prototype.searchCollapse = function () {
    ...
    StationDetailPage.prototype.hideSearchBar = function () {
        this.searchShow = false;
        this.searchFlag = 0;
    };
    StationDetailPage.prototype.stnStatusRedirect = function (StationId) {
        this.router.navigate(['station-status', { stationId: StationId }]);
    };
    StationDetailPage.prototype.updateStatus = function (i, StationId, event) {
        var _this = this;
        var self = this;
        this.commonServices.alertMessage("Confirm", "Do you want to change the status?").then(function (res) {
            ...
            if (!res) {
                ...
                self.commonServices.post("CommonGetData", { Flag: 'UpdateSOStatus',
                    Id: StationId, Status: _this.status }).subscribe(function (res) {
                ...
                _this.getCoStationData();
            }
        });
    };
    StationDetailPage.prototype.getCoStationData = function () {
        var self = this;
        self.commonServices.loadingPresent();
        self.commonServices.post("CommonGetData", { Flag: 'COListForCR', Id: self.userId }).subscribe(function (res) {
    ...
    StationDetailPage.prototype.getItems = function (ev) {
    ...
    StationDetailPage.prototype.exportFile = function () {
        var _this = this;
        this.commonServices.post("getAllDetails_CSV", { Flag: "COListForCR", Id: this.userId, PageFlag: 'COStations', Status: this.status }).subscribe(function (resp) {
    ...
    StationDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=CO-station-detail-station-detail-module-es5.js.map