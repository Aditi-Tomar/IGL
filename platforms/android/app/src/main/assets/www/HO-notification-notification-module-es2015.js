...
let NotificationPage = class NotificationPage {
    constructor(router, activatedRoute, commonServices, menu, modalController, dp) {
        this.router = router;
    ...
    NotiFicationData() {
        ...
        if (self.DepartmentCode == "HO") {
            self.commonServices.post("CommonGetData", { Flag: 'NotificationData', Id: 0 }).subscribe((res) => {
            ...
            self.commonServices.post("CommonGetData", { Flag: 'NotificationDetailsCO', ReportFlag: this.Reportflag, Id: this.userId, CDashdate: this.Cdate }).subscribe((res) => {
            ...
            self.commonServices.post("CommonGetData", { Flag: 'NotificationDetailsMO', ReportFlag: this.Reportflag, Id: this.userId, CDashdate: this.Cdate }).subscribe((res) => {
            ...
            self.commonServices.post("CommonGetData", { Flag: 'NotificationSOP', Id: self.userId, CDashdate: self.Cdate }).subscribe((res) => {
...
//# sourceMappingURL=HO-notification-notification-module-es2015.js.map