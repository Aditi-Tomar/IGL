...
let ProfileStationPageRoutingModule = class ProfileStationPageRoutingModule {
};
...
let ProfileStationPageModule = class ProfileStationPageModule {
};
...
let ProfileStationPage = class ProfileStationPage {
    constructor(commonServices) {
    ...
    profile() {
        var self = this;
        self.commonServices.post("CommonGetData", { Flag: 'SMProfile', Id: this.Uid }).subscribe((res) => {
...
ProfileStationPage.ctorParameters = () => [
...
//# sourceMappingURL=station-profile-station-profile-station-module-es2015.js.map